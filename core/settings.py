...
SECRET_KEY = 'django-insecure-ydi4np)g!^w76^1)6t7k++h%66z1j-p_kusyb53#_$lf%642o)'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_procesor.company_info',
                'accounts.context_procesor.global_search_data',
            ],
        },
    },
]
