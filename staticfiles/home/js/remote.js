(function (g) {
    var window = this; 'use strict'; var FYw = function (I) {
        if (I instanceof g.aK) return I; if (typeof I.ME == "function") return I.ME(!1); if (g.CQ(I)) {
            var U = 0, t = new g.aK; t.next = function () { for (; ;) { if (U >= I.length) return g.dz; if (U in I) return g.NE(I[U++]); U++ } };
            return t
        } throw Error("Not implemented");
    }, QW0 = function (I, U, t) {
        if (g.CQ(I)) g.Kt(I, U, t);
        else for (I = FYw(I); ;) { var W = I.next(); if (W.done) break; U.call(t, W.value, void 0, I) }
    }, Vr = function (I) {
        g.w2(I, "zx", Math.floor(Math.random() * 2147483648).toString(36) + Math.abs(Math.floor(Math.random() * 2147483648) ^ g.J$()).toString(36));
        return I
    }, M7 = function (I, U, t) {
        ...
        return t
    }, jWw = function (I, U) { fe6(I, U).forEach(function (t) { g.Fm.prototype.remove.call(this, t) }, I) }, A9w = function (I) {
        if (I.k$) {
            if (I.k$.locationOverrideToken) return { locationOverrideToken: I.k$.locationOverrideToken };
            if (I.k$.latitudeE7 != null && I.k$.longitudeE7 != null) return { latitudeE7: I.k$.latitudeE7, longitudeE7: I.k$.longitudeE7 }
        } return null
    }, sW6 = function (I, U) { g.G6(I, U) || I.push(U) }, aee = function (I) {
        var U = 0, t;
        for (t in I) U++; return U
    }, N2w = function (I, U) { return g.mn(I, U) }, J96 = function (I) {
        try { return g.Sk.JSON.parse(I) } catch (U) { } I = String(I);
        if (/^\s*$/.test(I) ? 0 : /^[\],:{}\s\u2028\u2029]*$/.test(I.replace(/\\["\\\/bfnrtu]/g, "@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g, "]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g, ""))) try { return eval("(" + I + ")") } catch (U) { } throw Error("Invalid JSON string: " + I);
    }, Pu = function (I) { if (g.Sk.JSON) try { return g.Sk.JSON.parse(I) } catch (U) { } return J96(I) }, o8Y = function () {
        var I = g.YS();
        this.B = I; I.Ld("/client_streamz/youtube/living_room/mdx/channel/opened", g.ds("channel_type"))
    }, XRw = function () {
        var I = g.YS();
        this.B = I; I.Ld("/client_streamz/youtube/living_room/mdx/channel/closed", g.ds("channel_type"))
    }, iUQ = function () {
        var I = g.YS();
        this.B = I; I.Ld("/client_streamz/youtube/living_room/mdx/channel/message_received", g.ds("channel_type"))
    }, YUL = function () {
        var I = g.YS();
        this.B = I; I.Ld("/client_streamz/youtube/living_room/mdx/channel/success")
    }, k3x = function () {
        var I = g.YS();
        this.B = I; I.Ld("/client_streamz/youtube/living_room/mdx/channel/error", g.ds("channel_type"), g.ds("error_type"))
    }, DO8 = function () {
        var I = g.YS();
        this.B = I; I.Ld("/client_streamz/youtube/living_room/mdx/browser_channel/pending_maps")
    }, xO$ = function () {
        var I = g.YS();
        this.B = I; I.Ld("/client_streamz/youtube/living_room/mdx/browser_channel/undelivered_maps")
    }, r9w = function (I, U, t, W) {
        var E = new g.Qz(null);
        I && g.UU(E, I); U && g.fm(E, U); t && g.t9(E, t); W && (E.J = W); return E
    }, G3w = function (I, U) { return new g.nU(I, U) }, I7 = function (I, U) { return Object.prototype.hasOwnProperty.call(I, U) }, qUY = function (I, U) { return I === U }, Uu = function (I, U) {
        this.J = {};
        this.B = []; this.JO = this.size = 0; var t = arguments.length; if (t > 1) { if (t % 2) throw Error("Uneven number of arguments"); for (var W = 0; W < t; W += 2)this.set(arguments[W], arguments[W + 1]) } else if (I) if (I instanceof Uu) for (t = I.Sd(), W = 0; W < t.length; W++)this.set(t[W], I.get(t[W])); else for (W in I) this.set(W, I[W])
    }, tk = function (I) {
        if (I.size != I.B.length) {
            for (var U = 0, t = 0; U < I.B.length;) {
                var W = I.B[U];
                I7(I.J, W) && (I.B[t++] = W); U++
            } I.B.length = t
        } if (I.size != I.B.length) { U = {}; for (W = t = 0; t < I.B.length;) { var E = I.B[t]; I7(U, E) || (I.B[W++] = E, U[E] = 1); t++ } I.B.length = W }
    }, W6 = function (I) {
        this.name = this.id = "";
        ...
        I.capabilities.clear();
        g.i1(U.split(","), g.sH(N2w, T2x)).forEach(function (t) { I.capabilities.add(t) })
    }, bUk = function (I, U) {
        I.compatibleSenderThemes.clear();
        g.i1(U.split(","), g.sH(N2w, RzH)).forEach(function (t) { I.compatibleSenderThemes.add(t) })
    }, B2L = function (I, U) {
        I.experiments.clear();
        U.split(",").forEach(function (t) { I.experiments.add(t) })
    }, Eu = function (I) {
        I = I || {};
        this.name = I.name || ""; this.id = I.id || I.screenId || ""; this.token = I.token || I.loungeToken || ""; this.uuid = I.uuid || I.dialId || ""; this.idType = I.screenIdType || "normal"; this.secret = I.screenIdSecret || ""
    }, Zv = function (I, U) { return !!U && (I.id == U || I.uuid == U) }, OUe = function (I) {
        return {
            name: I.name,
            screenId: I.id, loungeToken: I.token, dialId: I.uuid, screenIdType: I.idType, screenIdSecret: I.secret
        }
    }, n8f = function (I) { return new Eu(I) }, V$L = function (I) { return Array.isArray(I) ? g.F2(I, n8f) : [] }, H6 = function (I) { return I ? '{name:"' + I.name + '",id:' + I.id.substr(0, 6) + "..,token:" + ((I.token ? ".." + I.token.slice(-6) : "-") + ",uuid:" + (I.uuid ? ".." + I.uuid.slice(-6) : "-") + ",idType:" + I.idType + ",secret:") + ((I.secret ? ".." + I.secret.slice(-6) : "-") + "}") : "null" }, M$t = function (I) { return Array.isArray(I) ? "[" + g.F2(I, H6).join(",") + "]" : "null" },
        PgY = function () {
            ...
            return g.F2(I, function (U) {
                return {
                    key: U.id,
                    name: U.name
                }
            })
        }, UMH = function (I, U) { return g.xf(I, function (t) { return t || U ? !t != !U ? !1 : t.id == U.id : !0 }) }, wC = function (I, U) { return g.xf(I, function (t) { return Zv(t, U) }) }, tOt = function () {
            var I = g.jz.jK();
            I && jWw(I, I.O8.ME(!0))
        }, l4 = function () {
            var I = g.sC("yt-remote-connected-devices") || [];
            g.Hq(I); return I
        }, W9t = function (I) {
            if (I.length == 0) return [];
            var U = I[0].indexOf("#"), t = U == -1 ? I[0] : I[0].substring(0, U); return g.F2(I, function (W, E) { return E == 0 ? W : W.substring(t.length) })
        }, EJ0 = function (I) { g.AS("yt-remote-connected-devices", I, 86400) }, dC = function () {
            if (Zoe) return Zoe;
            var I = g.sC("yt-remote-device-id"); I || (I = PgY(), g.AS("yt-remote-device-id", I, 31536E3)); for (var U = l4(), t = 1, W = I; g.G6(U, W);)t++, W = I + "#" + t; return Zoe = W
        }, How = function () {
            var I = l4(), U = dC();
            g.NS() && g.d5(I, U); I = W9t(I); if (I.length == 0) try { g.oh("remote_sid") } catch (t) { } else try { g.NH("remote_sid", I.join(","), -1) } catch (t) { }
        }, wQx = function () { return g.sC("yt-remote-session-browser-channel") }, lGH = function () { return g.sC("yt-remote-local-screens") || [] }, dMQ = function () { g.AS("yt-remote-lounge-token-expiration", !0, 86400) }, K9x = function (I) {
            I.length > 5 && (I = I.slice(I.length - 5));
            ...
            g.AS("yt-remote-local-screens", I, 31536E3)
        }, KL = function (I) {
            I || (g.ao("yt-remote-session-screen-id"), g.ao("yt-remote-session-video-id"));
            How(); I = l4(); g.ek(I, dC()); EJ0(I)
        }, vJw = function () {
            if (!v6) {
                var I = g.aa();
                I && (v6 = new g.gT(I))
            ...
            vJw();
            return v6 ? !!v6.get("yt-remote-use-staging-server") : !1
        }, c6 = function (I, U) {
            g.qb[I] = !0;
            var t = g.rM(); t && t.publish.apply(t, arguments); g.qb[I] = !1
        }, $M6 = function () {
            var I = window.navigator.userAgent.match(/Chrome\/([0-9]+)/);
            return I ? parseInt(I[1], 10) : 0
        }, umQ = function (I) { return !!document.currentScript && (document.currentScript.src.indexOf("?" + I) != -1 || document.currentScript.src.indexOf("&" + I) != -1) }, hmw = function () { return typeof window.__onGCastApiAvailable == "function" ? window.__onGCastApiAvailable : null }, $0 = function (I) { I.length ? Sx8(I.shift(), function () { $0(I) }) : zmx() }, L9Y = function (I) { return "chrome-extension://" + I + "/cast_sender.js" }, Sx8 = function (I, U, t) {
            var W = document.createElement("script");
            W.onerror = U; t && (W.onload = t); g.a0(W, g.yM(I)); (document.head || document.documentElement).appendChild(W)
        }, pQL = function () {
            var I = $M6(), U = [];
            if (I > 1) { var t = I - 1; U.push("//www.gstatic.com/eureka/clank/" + I + "/cast_sender.js"); U.push("//www.gstatic.com/eureka/clank/" + t + "/cast_sender.js") } return U
        }, zmx = function () {
            var I = hmw();
            I && I(!1, "No cast extension found")
        }, gJV = function () {
            if (mM$) {
                var I = 2, U = hmw(), t = function () {
                    I--;
                    I == 0 && U && U(!0)
                };
                window.__onGCastApiAvailable = t; Sx8("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js", zmx, t)
            }
        }, Cqe = function () {
            gJV();
            var I = pQL(); I.push("//www.gstatic.com/eureka/clank/cast_sender.js"); $0(I)
        }, F9k = function () {
            gJV();
            var I = pQL(); I.push.apply(I, g.x(ym8.map(L9Y))); I.push("//www.gstatic.com/eureka/clank/cast_sender.js"); $0(I)
        }, u4 = function (I, U, t) {
            g.q.call(this);
            this.K = t != null ? (0, g.A$)(I, t) : I; this.CV = U; this.X = (0, g.A$)(this.DB, this); this.B = !1; this.J = 0; this.D = this.LL = null; this.T = []
        }, hk = function () { this.B = g.J$() }, QaY = function () { S8 || (S8 = new hk) }, fGw = function () { S8 || (S8 = new hk) }, zV = function () { }, jaV = function () { g.Vk.call(this, "p") }, AmQ = function () { g.Vk.call(this, "o") }, aGV = function () { return sa$ = sa$ || new g.$7 }, NTQ = function (I) { g.Vk.call(this, "serverreachability", I) }, LL = function (I) {
            var U = aGV();
            U.dispatchEvent(new NTQ(U, I))
        }, JmY = function (I) { g.Vk.call(this, "statevent", I) }, pL = function (I) {
            var U = aGV();
            U.dispatchEvent(new JmY(U, I))
        }, oJk = function (I, U, t, W) {
            g.Vk.call(this, "timingevent", I);
            this.size = U; this.rtt = t; this.retries = W
        }, ml = function (I, U) {
            if (typeof I !== "function") throw Error("Fn must not be null and must be a function");
            return g.Sk.setTimeout(function () { I() }, U)
        }, gC = function () { }, CL = function (I, U, t, W) {
            this.D = I;
            this.T = U; this.iU = t; this.nu = W || 1; this.oF = new g.vR(this); this.j6 = 45E3; this.QQ = null; this.K = !1; this.on = this.cK = this.W = this.ZK = this.l0 = this.OJ = this.mu = null; this.wk = []; this.B = null; this.Y = 0; this.X = this.u0 = null; this.Fp = -1; this.Rn = !1; this.PK = 0; this.YA = null; this.RF = this.Gg = this.k$ = this.rk = !1; this.J = new XQY
        }, XQY = function () {
            this.D = null;
            this.B = ""; this.J = !1
        }, Yxx = function (I, U, t) {
            I.ZK = 1;
            I.W = Vr(U.clone()); I.on = t; I.rk = !0; io0(I, null)
        }, io0 = function (I, U) {
            I.l0 = Date.now();
            yH(I); I.cK = I.W.clone(); M7(I.cK, "t", I.nu); I.Y = 0; var t = I.D.Gg; I.J = new XQY; I.B = kKY(I.D, t ? U : null, !I.on); I.PK > 0 && (I.YA = new g.RW((0, g.A$)(I.WA, I, I.B), I.PK)); I.oF.listen(I.B, "readystatechange", I.fA); U = I.QQ ? g.QC(I.QQ) : {}; I.on ? (I.u0 || (I.u0 = "POST"), U["Content-Type"] = "application/x-www-form-urlencoded", I.B.send(I.cK, I.u0, I.on, U)) : (I.u0 = "GET", I.B.send(I.cK, I.u0, null, U)); LL(1)
        }, xMk = function (I) {
            if (!DMx(I)) return g.BG(I.B);
            var U = g.Tu(I.B); if (U === "") return ""; var t = "", W = U.length, E = g.eY(I.B) == 4; if (!I.J.D) { if (typeof TextDecoder === "undefined") return FL(I), QH(I), ""; I.J.D = new g.Sk.TextDecoder } for (var Z = 0; Z < W; Z++)I.J.J = !0, t += I.J.D.decode(U[Z], { stream: !(E && Z == W - 1) }); U.length = 0; I.J.B += t; I.Y = 0; return I.J.B
        }, DMx = function (I) { return I.B ? I.u0 == "GET" && I.ZK != 2 && I.D.SB : !1 }, qxe = function (I, U) {
            var t = I.Y, W = U.indexOf("\n", t);
            if (W == -1) return rm0; t = Number(U.substring(t, W)); if (isNaN(t)) return GKQ; W += 1; if (W + t > U.length) return rm0; U = U.slice(W, W + t); I.Y = W + t; return U
        }, yH = function (I) {
            I.OJ = Date.now() + I.j6;
            emw(I, I.j6)
        }, emw = function (I, U) {
            if (I.mu != null) throw Error("WatchDog timer not null");
            I.mu = ml((0, g.A$)(I.Ak, I), U)
        }, boe = function (I) { I.mu && (g.Sk.clearTimeout(I.mu), I.mu = null) }, QH = function (I) { I.D.Mm() || I.Rn || BTQ(I.D, I) }, FL = function (I) {
            boe(I);
            g.vl(I.YA); I.YA = null; I.oF.removeAll(); if (I.B) { var U = I.B; I.B = null; U.abort(); U.dispose() }
        }, Ikf = function (I, U) {
            try {
                var t = I.D;
                if (t.YX != 0 && (t.B == I || TTx(t.J, I))) if (!I.Gg && TTx(t.J, I) && t.YX == 3) { try { var W = t.jQ.B.parse(U) } catch (y) { W = null } if (Array.isArray(W) && W.length == 3) { var E = W; if (E[0] == 0) a: { if (!t.W) { if (t.B) if (t.B.l0 + 3E3 < I.l0) fL(t), j8(t); else break a; RmL(t); pL(18) } } else t.PL = E[1], 0 < t.PL - t.ZK && E[2] < 37500 && t.YA && t.wk == 0 && !t.mu && (t.mu = ml((0, g.A$)(t.QG, t), 6E3)); if (Oow(t.J) <= 1 && t.Fp) { try { t.Fp() } catch (y) { } t.Fp = void 0 } } else Ak(t, 11) } else if ((I.Gg || t.B == I) && fL(t), !g.q2(U)) for (E = t.jQ.B.parse(U), U = 0; U < E.length; U++) {
                    var Z = E[U], H = Z[0]; if (!(H <=
                        t.ZK)) if (t.ZK = H, Z = Z[1], t.YX == 2) if (Z[0] == "c") {
                            t.T = Z[1]; t.iU = Z[2]; var l = Z[3]; l != null && (t.pC = l); var d = Z[5]; d != null && typeof d === "number" && d > 0 && (t.PK = 1.5 * d); W = t; var K = I.Oa(); if (K) { var v = g.RQ(K, "X-Client-Wire-Protocol"); if (v) { var c = W.J; !c.B && (g.Bq(v, "spdy") || g.Bq(v, "quic") || g.Bq(v, "h2")) && (c.T = c.X, c.B = new Set, c.J && (nJ$(c, c.J), c.J = null)) } if (W.rk) { var u = g.RQ(K, "X-HTTP-Session-Id"); u && (W.RW = u, g.w2(W.QQ, W.rk, u)) } } t.YX = 3; t.X && t.X.sZ(); t.BL && (t.e_ = Date.now() - I.l0); W = t; var h = I; W.pL = VOx(W, W.Gg ? W.iU : null, W.y5);
                            if (h.Gg) { MO8(W.J, h); var S = h, m = W.PK; m && S.setTimeout(m); S.mu && (boe(S), yH(S)); W.B = h } else Pqe(W); t.D.length > 0 && a7(t)
                        } else Z[0] != "stop" && Z[0] != "close" || Ak(t, 7); else t.YX == 3 && (Z[0] == "stop" || Z[0] == "close" ? Z[0] == "stop" ? Ak(t, 7) : t.disconnect() : Z[0] != "noop" && t.X && t.X.Ij(Z), t.wk = 0)
                } LL(4)
            } catch (y) { }
        }, UVw = function (I, U) {
            this.B = I;
            ...
            this.X = I || 10;
            g.Sk.PerformanceNavigationTiming ? (I = g.Sk.performance.getEntriesByType("navigation"), I = I.length > 0 && (I[0].nextHopProtocol == "hq" || I[0].nextHopProtocol == "h2")) : I = !!(g.Sk.chrome && g.Sk.chrome.loadTimes && g.Sk.chrome.loadTimes() && g.Sk.chrome.loadTimes().wasFetchedViaSpdy); this.T = I ? this.X : 1; this.B = null; this.T > 1 && (this.B = new Set); this.J = null; this.D = []
        }, Wd$ = function (I) { return I.J ? !0 : I.B ? I.B.size >= I.T : !1 }, Oow = function (I) { return I.J ? 1 : I.B ? I.B.size : 0 }, TTx = function (I, U) { return I.J ? I.J == U : I.B ? I.B.has(U) : !1 }, nJ$ =
            function (I, U) { I.B ? I.B.add(U) : I.J = U }, MO8 = function (I, U) { I.J && I.J == U ? I.J = null : I.B && I.B.has(U) && I.B.delete(U) }, E6$ = function (I) {
                if (I.J != null) return I.D.concat(I.J.wk);
                if (I.B != null && I.B.size !== 0) { var U = I.D; I = g.X(I.B.values()); for (var t = I.next(); !t.done; t = I.next())U = U.concat(t.value.wk); return U } return g.VL(I.D)
            }, ZpQ = function (I, U) {
                var t = new gC;
                if (g.Sk.Image) {
                    var W = new Image; W.onload = g.sH(N6, t, "TestLoadImage: loaded", !0, U, W); W.onerror = g.sH(N6, t, "TestLoadImage: error", !1, U, W); W.onabort = g.sH(N6, t, "TestLoadImage: abort", !1, U, W); W.ontimeout = g.sH(N6, t, "TestLoadImage: timeout", !1, U, W); g.Sk.setTimeout(function () { if (W.ontimeout) W.ontimeout() }, 1E4);
                    W.src = I
                } else U(!1)
            }, Hp$ = function (I, U) {
                var t = new gC, W = new AbortController, E = setTimeout(function () {
                    W.abort();
                    N6(t, "TestPingServer: timeout", !1, U)
                }, 1E4);
                fetch(I, { signal: W.signal }).then(function (Z) { clearTimeout(E); Z.ok ? N6(t, "TestPingServer: ok", !0, U) : N6(t, "TestPingServer: server error", !1, U) }).catch(function () {
                    clearTimeout(E);
                    N6(t, "TestPingServer: error", !1, U)
                })
            }, N6 = function (I, U, t, W, E) { try { E && (E.onload = null, E.onerror = null, E.onabort = null, E.ontimeout = null), W(t) } catch (Z) { } }, wD8 = function () { this.B = new zV }, Jk = function (I, U, t) { return t && t.snn ? t.snn[I] || U : U }, lkf = function (I) {
                this.D = [];
                this.iU = this.pL = this.QQ = this.y5 = this.B = this.RW = this.rk = this.Rn = this.Y = this.k$ = this.on = null; this.Ui = this.cK = 0; this.ub = Jk("failFast", !1, I); this.YA = this.mu = this.W = this.K = this.X = null; this.aF = !0; this.PL = this.ZK = -1; this.nu = this.wk = this.l0 = 0; this.yx = Jk("baseRetryDelayMs", 5E3, I); this.LJ = Jk("retryDelaySeedMs", 1E4, I); this.DS = Jk("forwardChannelMaxRetries", 2, I); this.jn = Jk("forwardChannelRequestTimeoutMs", 2E4, I); this.eQ = I && I.zXe || void 0; this.B5 = I && I.C74 || void 0; this.SB = I && I.dW4 || !1; this.PK = void 0; this.Gg = I && I.mld ||
                    !1; this.T = ""; this.J = new tR6(I && I.e$0); this.MF = Math.min(I && I.LWA || 1E3, 1E3); this.jQ = new wD8; this.oF = I && I.pFs || !1; this.OJ = I && I.nSk || !1; this.oF && this.OJ && (this.OJ = !1); this.Sz = I && I.zHs || !1; I && I.CAg && (this.aF = !1); this.BL = !this.oF && this.aF && I && I.Aol || !1; this.h3 = void 0; I && I.O$ && I.O$ > 0 && (this.h3 = I.O$); this.Fp = void 0; this.e_ = 0; this.j6 = !1; this.RF = this.u0 = null
            }, j8 = function (I) { I.B && (dVw(I), I.B.cancel(), I.B = null) }, Kdf = function (I) {
                j8(I);
                I.W && (g.Sk.clearTimeout(I.W), I.W = null); fL(I); I.J.cancel(); I.K && (typeof I.K === "number" && g.Sk.clearTimeout(I.K), I.K = null)
            }, a7 = function (I) { Wd$(I.J) || I.K || (I.K = !0, g.yh(I.iL, I), I.l0 = 0) }, ce6 = function (I, U) {
                if (Oow(I.J) >= I.J.T - (I.K ? 1 : 0)) return !1;
                if (I.K) return I.D = U.wk.concat(I.D), !0; if (I.YX == 1 || I.YX == 2 || I.l0 >= (I.ub ? 0 : I.DS)) return !1; I.K = ml((0, g.A$)(I.iL, I, U), v6w(I, I.l0)); I.l0++; return !0
            }, utf = function (I, U) {
                var t;
                U ? t = U.iU : t = I.cK++; var W = I.QQ.clone(); g.w2(W, "SID", I.T); g.w2(W, "RID", t); g.w2(W, "AID", I.ZK); o7(I, W); I.Y && I.on && g.KU(W, I.Y, I.on); t = new CL(I, I.T, t, I.l0 + 1); I.Y === null && (t.QQ = I.on); U && (I.D = U.wk.concat(I.D)); U = $V0(I, t, I.MF); t.setTimeout(Math.round(I.jn * .5) + Math.round(I.jn * .5 * Math.random())); nJ$(I.J, t); Yxx(t, W, U)
            }, o7 = function (I, U) {
                I.Rn && g.XG(I.Rn, function (t, W) { g.w2(U, W, t) });
                I.X && g.XG({}, function (t, W) { g.w2(U, W, t) })
            }, $V0 = function (I, U, t) {
                t = Math.min(I.D.length, t);
                var W = I.X ? (0, g.A$)(I.X.Rq, I.X, I) : null; a: {
                    for (var E = I.D, Z = -1; ;) {
                        var H = ["count=" + t]; Z == -1 ? t > 0 ? (Z = E[0].B, H.push("ofs=" + Z)) : Z = 0 : H.push("ofs=" + Z); for (var l = !0, d = 0; d < t; d++) {
                            var K = E[d].B, v = E[d].map; K -= Z; if (K < 0) Z = Math.max(0, E[d].B - 100), l = !1; else try {
                                K = "req" + K + "_" || ""; try { var c = v instanceof Map ? v : Object.entries(v); for (var u = g.X(c), h = u.next(); !h.done; h = u.next()) { var S = g.X(h.value), m = S.next().value, y = S.next().value, N = y; g.Fe(y) && (N = g.k7(y)); H.push(K + m + "=" + encodeURIComponent(N)) } } catch (a) {
                                    throw H.push(K + "type=" +
                                        encodeURIComponent("_badmap")), a;
                                }
                            } catch (a) { W && W(v) }
                        } if (l) { c = H.join("&"); break a }
                    } c = void 0
                } I = I.D.splice(0, t); U.wk = I; return c
            }, Pqe = function (I) { I.B || I.W || (I.nu = 1, g.yh(I.jf, I), I.wk = 0) }, RmL = function (I) {
                if (I.B || I.W || I.wk >= 3) return !1;
                I.nu++; I.W = ml((0, g.A$)(I.jf, I), v6w(I, I.wk)); I.wk++; return !0
            }, dVw = function (I) { I.u0 != null && (g.Sk.clearTimeout(I.u0), I.u0 = null) }, hNQ = function (I) {
                I.B = new CL(I, I.T, "rpc", I.nu);
                I.Y === null && (I.B.QQ = I.on); I.B.PK = 0; var U = I.pL.clone(); g.w2(U, "RID", "rpc"); g.w2(U, "SID", I.T); g.w2(U, "AID", I.ZK); g.w2(U, "CI", I.YA ? "0" : "1"); !I.YA && I.h3 && g.w2(U, "TO", I.h3); g.w2(U, "TYPE", "xmlhttp"); o7(I, U); I.Y && I.on && g.KU(U, I.Y, I.on); I.PK && I.B.setTimeout(I.PK); var t = I.B; I = I.iU; t.ZK = 1; t.W = Vr(U.clone()); t.on = null; t.rk = !0; io0(t, I)
            }, fL = function (I) { I.mu != null && (g.Sk.clearTimeout(I.mu), I.mu = null) }, BTQ = function (I, U) {
                var t = null;
                ...
                var t = I.yx + Math.floor(Math.random() *
                    I.LJ);
                I.isActive() || (t *= 2); return t * U
            }, Ak = function (I, U) {
                if (U == 2) {
                    var t = (0, g.A$)(I.e_J, I), W = I.B5, E = !W;
                    W = new g.Qz(W || "//www.google.com/images/cleardot.gif"); g.Sk.location && g.Sk.location.protocol == "http" || g.UU(W, "https"); Vr(W); E ? ZpQ(W.toString(), t) : Hp$(W.toString(), t)
                } else pL(2); I.YX = 0; I.X && I.X.PA(U); SVV(I); Kdf(I)
            }, SVV = function (I) {
                I.YX = 0;
                I.RF = []; if (I.X) { var U = E6$(I.J); if (U.length != 0 || I.D.length != 0) g.M8(I.RF, U), g.M8(I.RF, I.D), I.J.D.length = 0, g.VL(I.D), I.D.length = 0; I.X.CC() }
            }, zN6 = function (I) {
                if (I.YX == 0) return I.RF;
                var U = []; g.M8(U, E6$(I.J)); g.M8(U, I.D); return U
            }, VOx = function (I, U, t) {
                var W = g.Lm(t);
                W.B != "" ? (U && g.fm(W, U + "." + W.B), g.t9(W, W.D)) : (W = g.Sk.location, W = r9w(W.protocol, U ? U + "." + W.hostname : W.hostname, +W.port, t)); U = I.rk; t = I.RW; U && t && g.w2(W, U, t); g.w2(W, "VER", I.pC); o7(I, W); return W
            }, kKY = function (I, U, t) {
                if (U && !I.Gg) throw Error("Can't create secondary domain capable XhrIo object.");
                U = I.SB && !I.eQ ? new g.rb(new g.n_({ l8: t })) : new g.rb(I.eQ); U.Y = I.Gg; return U
            }, LdY = function () { }, pDL = function () { }, i4 = function (I, U) {
                g.$7.call(this);
                this.B = new lkf(U); this.X = I; this.J = U && U.W_n || null; I = U && U.Sru || null; U && U.ltg && (I ? I["X-Client-Protocol"] = "webchannel" : I = { "X-Client-Protocol": "webchannel" }); this.B.on = I; I = U && U.Dh0 || null; U && U.Je && (I ? I["X-WebChannel-Content-Type"] = U.Je : I = { "X-WebChannel-Content-Type": U.Je }); U && U.PP && (I ? I["X-WebChannel-Client-Profile"] = U.PP : I = { "X-WebChannel-Client-Profile": U.PP }); this.B.k$ = I; (I = U && U.rFl) && !g.q2(I) && (this.B.Y = I); this.K = U && U.mld || !1; this.T = U && U.f3J || !1; (U = U && U.pKk) && !g.q2(U) && (this.B.rk = U, g.pt(this.J, U) && (I =
                    this.J, U in I && delete I[U])); this.D = new XL(this)
            }, mVw = function (I) {
                jaV.call(this);
                I.__headers__ && (this.headers = I.__headers__, this.statusCode = I.__status__, delete I.__headers__, delete I.__status__); var U = I.__sm__; U ? this.data = (this.B = g.Sp(U)) ? g.yC(U, this.B) : U : this.data = I
            }, g6k = function (I) {
                AmQ.call(this);
                this.status = 1; this.errorCode = I
            }, XL = function (I) { this.B = I }, CPH = function (I, U) {
                this.J = I;
                this.B = U
            }, ye$ = function (I) {
                return zN6(I.B).map(function (U) {
                    var t = I.J;
                    U = U.map; "__data__" in U ? (U = U.__data__, t = t.T ? J96(U) : U) : t = U; return t
                })
            }, Y0 = function (I, U) {
                if (typeof I !== "function") throw Error("Fn must not be null and must be a function");
                return g.Sk.setTimeout(function () { I() }, U)
            }, Dv = function (I) { k0.dispatchEvent(new Fdt(k0, I)) }, Fdt = function (I) { g.Vk.call(this, "statevent", I) }, x0 = function (I, U, t, W) {
                this.B = I;
                this.T = U; this.Y = t; this.K = W || 1; this.J = 45E3; this.D = new g.vR(this); this.X = new g.Jd; this.X.setInterval(250)
            }, fkH = function (I, U, t) {
                I.zP = 1;
                I.z5 = Vr(U.clone()); I.Gl = t; I.rk = !0; Qpk(I, null)
            }, jp$ = function (I, U, t, W, E) {
                I.zP = 1;
                I.z5 = Vr(U.clone()); I.Gl = null; I.rk = t; E && (I.Tu = !1); Qpk(I, W)
            }, Qpk = function (I, U) {
                I.oI = Date.now();
                AeQ(I); I.dN = I.z5.clone(); M7(I.dN, "t", I.K); I.oC = 0; I.y3 = I.B.OQ(I.B.E0() ? U : null); I.d1 > 0 && (I.Na = new g.RW((0, g.A$)(I.aj, I, I.y3), I.d1)); I.D.listen(I.y3, "readystatechange", I.X_); U = I.Z3 ? g.QC(I.Z3) : {}; I.Gl ? (I.Bu = "POST", U["Content-Type"] = "application/x-www-form-urlencoded", I.y3.send(I.dN, I.Bu, I.Gl, U)) : (I.Bu = "GET", I.Tu && !g.Sy && (U.Connection = "close"), I.y3.send(I.dN, I.Bu, null, U)); I.B.hL(1)
            }, NEx = function (I, U) {
                var t = I.oC, W = U.indexOf("\n", t);
                if (W == -1) return spk; t = Number(U.substring(t, W)); if (isNaN(t)) return akx; W += 1; if (W + t > U.length) return spk; U = U.slice(W, W + t); I.oC = W + t; return U
            }, AeQ = function (I) {
                I.zU = Date.now() + I.J;
                JeV(I, I.J)
            }, JeV = function (I, U) {
                if (I.yC != null) throw Error("WatchDog timer not null");
                I.yC = Y0((0, g.A$)(I.Tp, I), U)
            }, o6H = function (I) { I.yC && (g.Sk.clearTimeout(I.yC), I.yC = null) }, XD8 = function (I) { I.B.Mm() || I.OS || I.B.oG(I) }, rC = function (I) {
                o6H(I);
                g.vl(I.Na); I.Na = null; I.X.stop(); I.D.removeAll(); if (I.y3) { var U = I.y3; I.y3 = null; U.abort(); U.dispose() } I.Ki && (I.Ki = null)
            }, ipx = function (I, U) { try { I.B.Ny(I, U), I.B.hL(4) } catch (t) { } }, kfH = function (I, U, t, W, E) {
                if (W == 0) t(!1);
                else { var Z = E || 0; W--; YVw(I, U, function (H) { H ? t(!0) : g.Sk.setTimeout(function () { kfH(I, U, t, W, Z) }, Z) }) }
            }, YVw = function (I, U, t) {
                var W = new Image;
                ...
                I.onload = null;
                I.onerror = null; I.onabort = null; I.ontimeout = null
            }, DV8 = function (I) {
                this.B = I;
                this.J = new zV
            }, xV$ = function (I) {
                var U = q6(I.B, I.jg, "/mail/images/cleardot.gif");
                Vr(U); kfH(U.toString(), 5E3, (0, g.A$)(I.du, I), 3, 2E3); I.hL(1)
            }, rew = function (I) {
                var U = I.B.K;
                U != null ? (Dv(5), U ? (Dv(11), e8(I.B, I, !1)) : (Dv(12), e8(I.B, I, !0))) : (I.Yr = new x0(I), I.Yr.Z3 = I.B$, U = I.B, U = q6(U, U.E0() ? I.mE : null, I.mz), Dv(5), M7(U, "TYPE", "xmlhttp"), jp$(I.Yr, U, !1, I.mE, !1))
            }, Gfk = function (I, U, t) {
                this.B = 1;
                this.J = []; this.D = []; this.X = new zV; this.on = I || null; this.K = U != null ? U : null; this.W = t || !1
            }, qVt = function (I, U) {
                this.B = I;
                this.map = U; this.context = null
            }, eNQ = function (I, U, t, W) {
                g.Vk.call(this, "timingevent", I);
                this.size = U; this.rtt = t; this.retries = W
            }, bp0 = function (I) { g.Vk.call(this, "serverreachability", I) }, TEf = function (I) {
                I.Hq(1, 0);
                I.Ef = q6(I, null, I.wK); BE6(I)
            }, RN6 = function (I) {
                I.jy && (I.jy.abort(), I.jy = null);
                I.W5 && (I.W5.cancel(), I.W5 = null); I.xL && (g.Sk.clearTimeout(I.xL), I.xL = null); TV(I); I.wj && (I.wj.cancel(), I.wj = null); I.Ao && (g.Sk.clearTimeout(I.Ao), I.Ao = null)
            }, Op8 = function (I, U) {
                if (I.B == 0) throw Error("Invalid operation: sending map when state is closed");
                I.J.push(new qVt(I.ZB++, U)); I.B != 2 && I.B != 3 || BE6(I)
            }, n6e = function (I) {
                var U = 0;
                I.W5 && U++; I.wj && U++; return U
            }, BE6 = function (I) { I.wj || I.Ao || (I.Ao = Y0((0, g.A$)(I.ma, I), 0), I.DT = 0) }, PPV = function (I, U) {
                if (I.B == 1) {
                    if (!U) {
                        I.F1 = Math.floor(Math.random() * 1E5);
                        U = I.F1++; var t = new x0(I, "", U); t.Z3 = I.Zz; var W = VRL(I), E = I.Ef.clone(); g.w2(E, "RID", U); g.w2(E, "CVER", "1"); R7(I, E); fkH(t, E, W); I.wj = t; I.B = 2
                    }
                } else I.B == 3 && (U ? MRQ(I, U) : I.J.length == 0 || I.wj || MRQ(I))
            }, MRQ = function (I, U) {
                if (U) if (I.MW > 6) {
                    I.J = I.D.concat(I.J);
                    I.D.length = 0; var t = I.F1 - 1; U = VRL(I)
                } else t = U.Y, U = U.Gl; else t = I.F1++, U = VRL(I); var W = I.Ef.clone(); g.w2(W, "SID", I.T); g.w2(W, "RID", t); g.w2(W, "AID", I.AR); R7(I, W); t = new x0(I, I.T, t, I.DT + 1); t.Z3 = I.Zz; t.setTimeout(1E4 + Math.round(1E4 * Math.random())); I.wj = t; fkH(t, W, U)
            }, R7 = function (I, U) { I.Ug && (I = I.Ug.JH()) && g.XG(I, function (t, W) { g.w2(U, W, t) }) }, VRL = function (I) {
                var U = Math.min(I.J.length, 1E3), t = ["count=" + U];
                ...
                return t.join("&")
            }, IMf = function (I) { I.W5 || I.xL || (I.Y = 1, I.xL = Y0((0, g.A$)(I.Bh, I), 0), I.rL = 0) }, tc$ = function (I) {
                if (I.W5 || I.xL || I.rL >= 3) return !1;
                I.Y++; I.xL = Y0((0, g.A$)(I.Bh, I), UH0(I, I.rL)); I.rL++; return !0
            }, e8 = function (I, U, t) {
                I.AE = I.K == null ? t : !I.K;
                I.BI = U.nS; I.W || TEf(I)
            }, TV = function (I) { I.xR != null && (g.Sk.clearTimeout(I.xR), I.xR = null) }, UH0 = function (I, U) {
                var t = 5E3 + Math.floor(Math.random() * 1E4);
                I.isActive() || (t *= 2); return t * U
            }, Ou = function (I, U) {
                if (U == 2 || U == 9) {
                    var t = null;
                    I.Ug && (t = null); var W = (0, g.A$)(I.lPn, I); t || (t = new g.Qz("//www.google.com/images/cleardot.gif"), Vr(t)); YVw(t.toString(), 1E4, W)
                } else Dv(2); Wmw(I, U)
            }, Wmw = function (I, U) {
                I.B = 0;
                I.Ug && I.Ug.Ez(U); Ep0(I); RN6(I)
            }, Ep0 = function (I) {
                I.B = 0;
                I.BI = -1; if (I.Ug) if (I.D.length == 0 && I.J.length == 0) I.Ug.FU(); else { var U = g.VL(I.D), t = g.VL(I.J); I.D.length = 0; I.J.length = 0; I.Ug.FU(U, t) }
            }, q6 = function (I, U, t) {
                var W = g.Lm(t);
                ...
                g.w2(W, "VER", I.MW); R7(I, W); return W
            }, ZAe = function () { }, HAQ = function () {
                this.B = [];
                this.J = []
            }, wKL = function (I) {
                g.Vk.call(this, "channelMessage");
                this.message = I
            }, lMk = function (I) {
                g.Vk.call(this, "channelError");
                this.error = I
            }, dHL = function (I, U) {
                this.action = I;
                this.params = U || {}
                ...
                g.q.call(this);
                this.B = new g.e$(this.z9e, 0, this); g.e(this, this.B); this.CV = 5E3; this.retryCount = this.Ed = 0; if (typeof I === "function") U && (I = (0, g.A$)(I, U)); else if (I && typeof I.handleEvent === "function") I = (0, g.A$)(I.handleEvent, I); else throw Error("Invalid listener argument"); this.J = I
            }, KmV = function (I, U, t, W, E, Z, H, l, d, K, v, c, u, h, S) {
                var m = this;
                ...
                this.B = null; this.on = !1; this.wk = null; this.rk = ""; this.u0 = this.mu = 0; this.T = []; this.nu = t; this.QQ = W; this.Y = Z; this.Gg = l; this.ZK = d; this.iU = H; this.Rn = null; this.X = g.jY(); this.y5 = E; this.k$ = K; this.Fp = v; this.aF = c; this.RF = u; this.OJ = new o8Y; this.cK = new XRw; this.oF = new YUL; this.j6 = new iUQ; this.PK = new k3x; this.BL = new DO8; this.e_ = new xO$
            }, $HQ = function (I, U, t, W, E) {
                vpL(I);
                if (I.B) { var Z = g.bP("ID_TOKEN"), H = I.B.Zz || {}; Z ? H["x-youtube-identity-token"] = Z : delete H["x-youtube-identity-token"]; I.B.Zz = H } cve(I); W ? (W.getState() != 3 && n6e(W) == 0 || W.getState(), I.B.connect(U, t, I.l0, W.T, W.AR)) : E ? I.B.connect(U, t, I.l0, E.sessionId, E.arrayId) : I.B.connect(U, t, I.l0); I.D && !I.J.isActive() && I.J.start(); I.K && I.K.gRg()
            }, zvf = function (I, U) { return I.aF ? !0 : I.Fp ? Object.values(uu6).includes(U) : I.k$ ? !Object.values(hvx).includes(U) : I.RF ? Object.values(SbV).includes(U) : !1 }, mHV = function (I) {
                var U, t;
                g.r(function (W) { if (W.J == 1) return W.l0(2), W.B(Lm0(I), 2); W.W(); U = I.T; I.T = []; t = U.length; pKx(I, U, t); VH(I); return W.on(0) })
            }, pKx = function (I, U, t) {
                for (var W = 0; W < t; ++W)Op8(I.B, U[W]);
                VH(I)
            }, VH = function (I) {
                I.publish("handlerOpened");
                I.OJ.HQ("BROWSER_CHANNEL")
            }, vpL = function (I) {
                if (I.B) {
                    var U = I.QQ(), t = I.B.Zz || {};
                    U ? t["x-youtube-lounge-xsrf-token"] = U : delete t["x-youtube-lounge-xsrf-token"]; I.B.Zz = t
                }
            }, Lm0 = function (I) {
                if (!I.iU) return gpH(I);
                I.Rn === null && (I.Rn = gpH(I)); return I.Rn
            }, gpH = function (I) { return g.aQ(I.Gg().then(function (U) { Co$(I, U) }).jI(function () { }), function () { I.Rn = null }) }, Co$ = function (I, U) {
                if (I.B) {
                    var t = I.B.Zz || {};
                    U && Object.keys(U).length > 0 ? t = Object.assign({}, t, U) : delete t.Authorization; I.B.Zz = t
                }
            }, cve = function (I) { I.ZK && !I.Y && Co$(I, I.ZK()) }, M6 = function (I) {
                this.scheme = "https";
                this.port = this.domain = ""; this.B = "/api/lounge"; this.J = !0; I = I || document.location.href; var U = Number(g.pR(I)[4] || null) || ""; U && (this.port = ":" + U); this.domain = g.m4(I) || ""; I = g.VC(); I.search("MSIE") >= 0 && (I = I.match(/MSIE ([\d.]+)/)[1], g.nt(I, "10.0") < 0 && (this.J = !1))
            }, P6 = function (I, U) {
                var t = I.B;
                I.J && (t = I.scheme + "://" + I.domain + I.port + I.B); return g.jo(t + U, {})
            }, yvw = function (I, U) {
                g.$7.call(this);
                ...
                this.handler.subscribe("handlerMessage", this.onMessage, this); this.B = U
            }, Fmw = function (I, U, t) {
                var W = this;
                ...
                this.T = {}; this.J = {}; this.mu = !1; this.logger = null; this.wk = []; this.AD = void 0; this.QQ = new o8Y; this.u0 = new XRw; this.Rn = new iUQ; this.rk = new k3x
            }, QhH = function (I) {
                g.HG(I.channel, "m", function () {
                    I.K = 3;
                ...
                g.HG(I.channel, "o", function () { I.AD === 401 || I.D.start(); I.publish("webChannelError"); I.rk.HQ("WEB_CHANNEL", "") })
            }, fMV = function (I) {
                var U = I.l0();
                U ? I.T["x-youtube-lounge-xsrf-token"] = U : delete I.T["x-youtube-lounge-xsrf-token"]
            }, jh0 = function (I) {
                g.$7.call(this);
                this.B = I(); this.B.subscribe("webChannelOpened", this.Mr, this); this.B.subscribe("webChannelClosed", this.onClosed, this); this.B.subscribe("webChannelError", this.onError, this); this.B.subscribe("webChannelMessage", this.onMessage, this)
            }, AvL = function (I, U, t, W, E) {
                function Z() { return new KmV(P6(I, "/bc"), U, !1, t, W) }
                t = t === void 0 ? function () { return "" } : t;
                return g.Sc("enable_mdx_web_channel_desktop") ? new jh0(function () { return new Fmw(P6(I, "/wc"), U, t) }) : new yvw(Z, E)
            }, Jvt = function () {
                var I = sht;
                aMk(); I1.push(I); N4e()
            }, Ul = function (I, U) {
                aMk();
                var t = opk(I, String(U)); I1.length == 0 ? XKf(t) : (N4e(), g.Kt(I1, function (W) { W(t) }))
            }, tN = function (I) { Ul("CP", I) }, aMk = function () { I1 || (I1 = g.pQ("yt.mdx.remote.debug.handlers_") || [], g.z6("yt.mdx.remote.debug.handlers_", I1)) }, XKf = function (I) {
                var U = (WE + 1) % 50;
                WE = U; El[U] = I; ZD || (ZD = U == 49)
            }, N4e = function () {
                var I = I1;
                if (El[0]) {
                    var U = ZD ? WE : -1, t = {}; do t = { sT: void 0 }, U = (U + 1) % 50, t.sT = El[U], g.Kt(I, function (W) { return function (E) { E(W.sT) } }(t));
                    while (U != WE); El = Array(50); WE = -1; ZD = !1
                }
            }, opk = function (I, U) {
                var t = (Date.now() - iAH) / 1E3;
                t.toFixed && (t = t.toFixed(3)); var W = []; W.push("[", t + "s", "] "); W.push("[", "yt.mdx.remote", "] "); W.push(I + ": " + U, "\n"); return W.join("")
            }, HE = function (I) {
                g.OR.call(this);
                this.K = I; this.screens = []
            }, Ybf = function (I, U) {
                var t = I.get(U.uuid) || I.get(U.id);
                if (t) return I = t.name, t.id = U.id || t.id, t.name = U.name, t.token = U.token, t.uuid = U.uuid || t.uuid, t.name != I; I.screens.push(U); return !0
            }, k_$ = function (I, U) {
                var t = I.screens.length != U.length;
                I.screens = g.i1(I.screens, function (Z) { return !!UMH(U, Z) });
                for (var W = U.length, E = 0; E < W; E++)t = Ybf(I, U[E]) || t; return t
            }, DHQ = function (I, U) {
                var t = I.screens.length;
                I.screens = g.i1(I.screens, function (W) { return !(W || U ? !W != !U ? 0 : W.id == U.id : 1) });
                return I.screens.length < t
            }, xH0 = function (I, U, t, W, E) {
                g.OR.call(this);
                this.D = I; this.Y = U; this.T = t; this.K = W; this.X = E; this.J = 0; this.B = null; this.LL = NaN
            }, lV = function (I) {
                HE.call(this, "LocalScreenService");
                this.J = I; this.B = NaN; wP(this); this.info("Initializing with " + M$t(this.screens))
            }, rve = function (I) {
                if (I.screens.length) {
                    var U = g.F2(I.screens, function (W) { return W.id }), t = P6(I.J, "/pairing/get_lounge_token_batch");
                    I.J.sendRequest("POST", t, { screen_ids: U.join(",") }, (0, g.A$)(I.As6, I), (0, g.A$)(I.Ddu, I))
                }
            }, wP = function (I) {
                if (g.Sc("deprecate_pair_servlet_enabled")) return k_$(I, []);
                var U = V$L(lGH()); U = g.i1(U, function (t) { return !t.uuid });
                return k_$(I, U)
            }, dP = function (I, U) {
                K9x(g.F2(I.screens, OUe));
                U && dMQ()
            }, qbw = function (I, U) {
                g.OR.call(this);
                this.K = U; U = (U = g.sC("yt-remote-online-screen-ids") || "") ? U.split(",") : []; for (var t = {}, W = this.K(), E = W.length, Z = 0; Z < E; ++Z) { var H = W[Z].id; t[H] = g.G6(U, H) } this.B = t; this.X = I; this.D = this.T = NaN; this.J = null; G_x("Initialized with " + g.k7(this.B))
            }, evQ = function (I, U, t) {
                var W = P6(I.X, "/pairing/get_screen_availability");
                I.X.sendRequest("POST", W, { lounge_token: U.token }, (0, g.A$)(function (E) { E = E.screens || []; for (var Z = E.length, H = 0; H < Z; ++H)if (E[H].loungeToken == U.token) { t(E[H].status == "online"); return } t(!1) }, I), (0, g.A$)(function () { t(!1) }, I))
            }, B4k = function (I, U) {
                a: if (aee(U) != aee(I.B)) var t = !1;
                else { t = g.Lt(U); for (var W = t.length, E = 0; E < W; ++E)if (!I.B[t[E]]) { t = !1; break a } t = !0 } t || (G_x("Updated online screens: " + g.k7(I.B)), I.B = U, I.publish("screenChange")); bAw(I)
            }, Kq = function (I) {
                isNaN(I.D) || g.$p(I.D);
                I.D = g.vK((0, g.A$)(I.n6, I), I.T > 0 && I.T < g.J$() ? 2E4 : 1E4)
            }, G_x = function (I) { Ul("OnlineScreenService", I) }, T4f = function (I) {
                var U = {};
                g.Kt(I.K(), function (t) { t.token ? U[t.token] = t.id : this.Oi("Requesting availability of screen w/o lounge token.") });
                return U
            }, bAw = function (I) {
                I = g.Lt(g.$i(I.B, function (U) { return U }));
                g.Hq(I); I.length ? g.AS("yt-remote-online-screen-ids", I.join(","), 60) : g.ao("yt-remote-online-screen-ids")
            }, vE = function (I, U) {
                U = U === void 0 ? !1 : U;
                HE.call(this, "ScreenService"); this.T = I; this.Y = U; this.B = this.J = null; this.D = []; this.X = {}; Rvt(this)
            }, npf = function (I, U, t, W, E, Z) {
                I.info("getAutomaticScreenByIds " + t + " / " + U);
                t || (t = I.X[U]); var H = I.Ii(), l = t ? wC(H, t) : null; t && (I.Y || l) || (l = wC(H, U)); if (l) { l.uuid = U; var d = cE(I, l); evQ(I.B, d, function (K) { E(K ? d : null) }) } else t ? OAL(I, t, (0, g.A$)(function (K) {
                    var v = cE(this, new Eu({
                        name: W,
                        screenId: t, loungeToken: K, dialId: U || ""
                    })); evQ(this.B, v, function (c) { E(c ? v : null) })
                }, I), Z) : E(null)
            }, VcV = function (I, U) {
                for (var t = I.screens.length, W = 0; W < t; ++W)if (I.screens[W].name == U) return I.screens[W];
                return null
            }, Mcw = function (I, U, t) { evQ(I.B, U, t) }, OAL = function (I, U, t, W) {
                I.info("requestLoungeToken_ for " + U);
                var E = {
                    postParams: { screen_ids: U }, method: "POST", context: I, onSuccess: function (Z, H) { Z = H && H.screens || []; Z[0] && Z[0].screenId == U ? t(Z[0].loungeToken) : W(Error("Missing lounge token in token response")) },
                    onError: function () { W(Error("Request screen lounge token failed")) }
                };
                g.g4(P6(I.T, "/pairing/get_lounge_token_batch"), E)
            }, Poe = function (I) {
                I.screens = I.J.Ii();
                var U = I.X, t = {}, W; for (W in U) t[U[W]] = W; U = I.screens.length; for (W = 0; W < U; ++W) { var E = I.screens[W]; E.uuid = t[E.id] || "" } I.info("Updated manual screens: " + M$t(I.screens))
            }, Rvt = function (I) {
                I3x(I);
                I.J = new lV(I.T); I.J.subscribe("screenChange", (0, g.A$)(I.Zls, I)); Poe(I); I.Y || (I.D = V$L(g.sC("yt-remote-automatic-screen-cache") || [])); I3x(I); I.info("Initializing automatic screens: " + M$t(I.D)); I.B = new qbw(I.T, (0, g.A$)(I.Ii, I, !0)); I.B.subscribe("screenChange", (0, g.A$)(function () { this.publish("onlineScreenChange") }, I))
            }, cE = function (I, U) {
                var t = I.get(U.id);
                t ? (t.uuid = U.uuid, U = t) : ((t = wC(I.D, U.uuid)) ? (t.id = U.id, t.token = U.token, U = t) : I.D.push(U), I.Y || USe(I)); I3x(I); I.X[U.uuid] = U.id; g.AS("yt-remote-device-id-map", I.X, 31536E3); return U
            }, USe = function (I) {
                I = g.i1(I.D, function (U) { return U.idType != "shortLived" });
                g.AS("yt-remote-automatic-screen-cache", g.F2(I, OUe))
            }, I3x = function (I) { I.X = g.sC("yt-remote-device-id-map") || {} }, $r = function (I, U, t) {
                g.OR.call(this);
                this.rk = t; this.T = I; this.J = U; this.B = null
            }, uV = function (I, U) {
                I.B = U;
                I.publish("sessionScreen", I.B)
            }, tzQ = function (I, U) {
                I.B && (I.B.token = U, cE(I.T, I.B));
                I.publish("sessionScreen", I.B)
            }, hN = function (I, U) { Ul(I.rk, U) }, SU = function (I, U, t) {
                $r.call(this, I, U, "CastSession");
                ...
                this.Y = this.X = this.K = this.W = 0; this.l0 = !1; this.on = "unknown"
            }, Z4Y = function (I, U) {
                g.$p(I.Y);
                I.Y = 0; U == 0 ? E2k(I) : I.Y = g.vK(function () { E2k(I) }, U)
            }, E2k = function (I) {
                H4Q(I, "getLoungeToken");
                g.$p(I.X); I.X = g.vK(function () { wdV(I, null) }, 3E4)
            }, H4Q = function (I, U) {
                I.info("sendYoutubeMessage_: " + U + " " + g.k7());
                var t = {}; t.type = U; I.D ? I.D.sendMessage("urn:x-cast:com.google.youtube.mdx", t, function () { }, (0, g.A$)(function () { hN(this, "Failed to send message: " + U + ".") }, I)) : hN(I, "Sending yt message without session: " + g.k7(t))
            }, l3f = function (I, U) { U ? (I.info("onConnectedScreenId_: Received screenId: " + U), I.B && I.B.id == U || I.Rm(U, function (t) { uV(I, t) }, function () { return I.Kp() }, 5)) : I.Kp(Error("Waiting for session status timed out.")) }, K0x = function (I, U, t) {
                I.info("onConnectedScreenData_: Received screenData: " + JSON.stringify(U));
                var W = new Eu(U); dSQ(I, W, function (E) { E ? (I.l0 = !0, cE(I.T, W), uV(I, W), I.on = "unknown", Z4Y(I, t)) : (g.Rp(Error("CastSession, RemoteScreen from screenData: " + JSON.stringify(U) + " is not online.")), I.Kp()) }, 5)
            }, W0V = function (I, U) {
                g.$p(I.mu);
                I.mu = 0; U ? I.config_.enableCastLoungeToken && U.loungeToken ? U.deviceId ? I.B && I.B.uuid == U.deviceId || (U.loungeTokenRefreshIntervalMs ? K0x(I, { name: I.J.friendlyName, screenId: U.screenId, loungeToken: U.loungeToken, dialId: U.deviceId, screenIdType: "shortLived" }, U.loungeTokenRefreshIntervalMs) : (g.Rp(Error("No loungeTokenRefreshIntervalMs presents in mdxSessionStatusData: " + JSON.stringify(U) + ".")), l3f(I, U.screenId))) : (g.Rp(Error("No device id presents in mdxSessionStatusData: " + JSON.stringify(U) + ".")), l3f(I, U.screenId)) :
                    l3f(I, U.screenId) : I.Kp(Error("Waiting for session status timed out."))
            }, wdV = function (I, U) {
                g.$p(I.X);
            ...
            }, dSQ = function (I, U, t, W) {
                g.$p(I.K);
                I.K = 0; Mcw(I.T, U, function (E) { E || W < 0 ? t(E) : I.K = g.vK(function () { dSQ(I, U, t, W - 1) }, 300) })
            }, v2w = function (I) {
                g.$p(I.W);
                I.W = 0; g.$p(I.K); I.K = 0; g.$p(I.mu); I.mu = 0; g.$p(I.X); I.X = 0; g.$p(I.Y); I.Y = 0
            }, zW = function (I, U, t, W) {
                $r.call(this, I, U, "DialSession");
                ...
                this.Y = this.K = 0; this.wk = !1; this.l0 = "unknown"
            }, Lq = function (I) {
                var U;
                return !!(I.config_.enableDialLoungeToken && ((U = I.D) == null ? 0 : U.getDialAppInfo))
            }, cSf = function (I) {
                I.X = I.T.rR(I.u0, I.J.label, I.J.friendlyName, Lq(I), function (U, t) {
                    I.X = function () { };
                    I.wk = !0; uV(I, U); U.idType == "shortLived" && t > 0 && pq(I, t)
                }, function (U) {
                    I.X = function () { };
                    I.Kp(U)
                })
                ...
                var U = {};
                U.pairingCode = I.u0; U.theme = I.ZK; cm6() && (U.env_useStageMdx = 1); return g.fR(U)
            }, uVx = function (I) {
                return new Promise(function (U) {
                    I.u0 = PgY();
                    if (I.QQ) { var t = new chrome.cast.DialLaunchResponse(!0, $Sw(I)); U(t); cSf(I) } else I.mu = function () {
                        g.$p(I.on); I.mu = function () { };
                        I.on = NaN; var W = new chrome.cast.DialLaunchResponse(!0, $Sw(I)); U(W); cSf(I)
                    }, I.on = g.vK(function () { I.mu() }, 100)
                })
            }, SCk = function (I, U, t) {
                I.info("initOnConnectedScreenDataPromise_: Received screenData: " + JSON.stringify(U));
                var W = new Eu(U); return (new Promise(function (E) { hwH(I, W, function (Z) { Z ? (I.wk = !0, cE(I.T, W), uV(I, W), pq(I, t)) : g.Rp(Error("DialSession, RemoteScreen from screenData: " + JSON.stringify(U) + " is not online.")); E(Z) }, 5) })).then(function (E) { return E ? new chrome.cast.DialLaunchResponse(!1) : uVx(I) })
            }, zw0 = function (I, U) {
                var t = I.W.receiver.label, W = I.J.friendlyName;
                return (new Promise(function (E) {
                    npf(I.T, t, U, W, function (Z) { Z && Z.token && uV(I, Z); E(Z) }, function (Z) {
                        hN(I, "Failed to get DIAL screen: " + Z);
                        E(null)
                    })
                })).then(function (E) { return E && E.token ? new chrome.cast.DialLaunchResponse(!1) : uVx(I) })
            }, hwH = function (I, U, t, W) {
                g.$p(I.K);
                I.K = 0; Mcw(I.T, U, function (E) { E || W < 0 ? t(E) : I.K = g.vK(function () { hwH(I, U, t, W - 1) }, 300) })
            }, pq = function (I, U) {
                I.info("getDialAppInfoWithTimeout_ " + U);
                Lq(I) && (g.$p(I.Y), I.Y = 0, U == 0 ? L0$(I) : I.Y = g.vK(function () { L0$(I) }, U))
            }, L0$ = function (I) {
                Lq(I) && I.D.getDialAppInfo(function (U) {
                    I.info("getDialAppInfo dialLaunchData: " + JSON.stringify(U));
                    U = U.extraData || {}; var t = null; if (U.loungeToken) { var W; ((W = I.B) == null ? void 0 : W.token) == U.loungeToken && (t = "staleLoungeToken") } else t = "missingLoungeToken"; t ? (I.l0 = t, pq(I, 3E4)) : (I.wk = !1, I.l0 = "unknown", tzQ(I, U.loungeToken), pq(I, U.loungeTokenRefreshIntervalMs))
                }, function (U) {
                    I.info("getDialAppInfo error: " + U);
                    I.l0 = "noLoungeTokenResponse"; pq(I, 3E4)
                })
            }, pdH = function (I) {
                g.$p(I.K);
                ...
                $r.call(this, I, U, "ManualSession");
                this.D = g.vK((0, g.A$)(this.Fc, this, null), 150)
            }, gP = function (I, U) {
                g.OR.call(this);
                this.config_ = U; this.J = I; this.W = U.appId || "233637DE"; this.T = U.theme || "cl"; this.on = U.disableCastApi || !1; this.K = U.forceMirroring || !1; this.B = null; this.Y = !1; this.D = []; this.X = (0, g.A$)(this.JU4, this)
            }, mS8 = function (I, U) { return U ? g.xf(I.D, function (t) { return Zv(U, t.label) }, I) : null }, Cq = function (I) { Ul("Controller", I) }, sht = function (I) { window.chrome && chrome.cast && chrome.cast.logMessage && chrome.cast.logMessage(I) }, yT = function (I) { return I.Y || !!I.D.length || !!I.B }, Fw = function (I, U, t) {
                U != I.B && (g.vl(I.B), (I.B = U) ? (t ? I.publish("yt-remote-cast2-receiver-resumed",
                    U.J) : I.publish("yt-remote-cast2-receiver-selected", U.J), U.subscribe("sessionScreen", (0, g.A$)(I.y6, I, U)), U.subscribe("sessionFailed", function () { return g2L(I, U) }), U.B ? I.publish("yt-remote-cast2-session-change", U.B) : t && I.B.Fc(null)) : I.publish("yt-remote-cast2-session-change", null))
            }, g2L = function (I, U) { I.B == U && I.publish("yt-remote-cast2-session-failed") }, CNY = function (I) {
                var U = I.J.y7(), t = I.B && I.B.J;
                ...
                t && (t.receiverType != chrome.cast.ReceiverType.CUSTOM && (t = new chrome.cast.Receiver(t.label, t.friendlyName), t.receiverType = chrome.cast.ReceiverType.CUSTOM), I.push(t)); return I
            }, a3H = function (I, U, t, W) {
                W.disableCastApi ? QT("Cannot initialize because disabled by Mdx config.") : ySe() ? F00(U, W) && (Qo0(!0), window.chrome && chrome.cast && chrome.cast.isAvailable ? f3H(I, t) : (window.__onGCastApiAvailable = function (E, Z) {
                    E ? f3H(I, t) : (fq("Failed to load cast API: " + Z), jo$(!1), Qo0(!1), g.ao("yt-remote-cast-available"), g.ao("yt-remote-cast-receiver"),
                        ASY(), t(!1))
                }, W.loadCastApiSetupScript ? g.RS(so6) : window.navigator.userAgent.indexOf("Android") >= 0 && window.navigator.userAgent.indexOf("Chrome/") >= 0 && window.navigator.presentation ? $M6() >= 60 && Cqe() : !window.chrome || !window.navigator.presentation || window.navigator.userAgent.indexOf("Edge") >= 0 ? zmx() : $M6() >= 89 ? F9k() : (gJV(), $0(ym8.map(L9Y))))) : QT("Cannot initialize because not running Chrome")
            }, ASY = function () {
                QT("dispose");
                var I = jU(); I && I.dispose(); g.z6("yt.mdx.remote.cloudview.instance_", null); NpL(!1); g.BF(JSx); JSx.length = 0
            }, AN = function () { return !!g.sC("yt-remote-cast-installed") }, o2L = function () {
                var I = g.sC("yt-remote-cast-receiver");
                return I ? I.friendlyName : null
            }, Xdf = function () {
                QT("clearCurrentReceiver");
                g.ao("yt-remote-cast-receiver")
            }, i4k = function () { return AN() ? jU() ? jU().getCastSession() : (fq("getCastSelector: Cast is not initialized."), null) : (fq("getCastSelector: Cast API is not installed!"), null) }, YCH = function () { AN() ? jU() ? sl() ? (QT("Requesting cast selector."), jU().requestSession()) : (QT("Wait for cast API to be ready to request the session."), JSx.push(g.b0("yt-remote-cast2-api-ready", YCH))) : fq("requestCastSelector: Cast is not initialized.") : fq("requestCastSelector: Cast API is not installed!") },
        a1 = function (I, U) { sl() ? jU().setConnectedScreenStatus(I, U) : fq("setConnectedScreenStatus called before ready.") }, ySe = function () {
            var I = g.VC().search(/ (CrMo|Chrome|CriOS)\//) >= 0;
            return g.Wx || I
        }, kFH = function (I, U) { jU().init(I, U) }, F00 = function (I, U) {
            var t = !1;
            jU() || (I = new gP(I, U), I.subscribe("yt-remote-cast2-availability-change", function (W) { g.AS("yt-remote-cast-available", W); c6("yt-remote-cast2-availability-change", W) }), I.subscribe("yt-remote-cast2-receiver-selected", function (W) {
                QT("onReceiverSelected: " + W.friendlyName);
                g.AS("yt-remote-cast-receiver", W); c6("yt-remote-cast2-receiver-selected", W)
            }), I.subscribe("yt-remote-cast2-receiver-resumed", function (W) {
                QT("onReceiverResumed: " + W.friendlyName);
                g.AS("yt-remote-cast-receiver", W); c6("yt-remote-cast2-receiver-resumed", W)
            }), I.subscribe("yt-remote-cast2-session-change", function (W) {
                QT("onSessionChange: " + H6(W));
                W || g.ao("yt-remote-cast-receiver"); c6("yt-remote-cast2-session-change", W)
            }), g.z6("yt.mdx.remote.cloudview.instance_", I), t = !0);
            QT("cloudview.createSingleton_: " + t); return t
        }, jU = function () { return g.pQ("yt.mdx.remote.cloudview.instance_") }, f3H = function (I, U) {
            jo$(!0);
            Qo0(!1); kFH(I, function (t) { t ? (NpL(!0), g.Tq("yt-remote-cast2-api-ready")) : (fq("Failed to initialize cast API."), jo$(!1), g.ao("yt-remote-cast-available"), g.ao("yt-remote-cast-receiver"), ASY()); U(t) })
        }, QT = function (I) { Ul("cloudview", I) }, fq = function (I) { Ul("cloudview", I) }, jo$ = function (I) {
            QT("setCastInstalled_ " + I);
            g.AS("yt-remote-cast-installed", I)
        }, sl = function () { return !!g.pQ("yt.mdx.remote.cloudview.apiReady_") }, NpL = function (I) {
            QT("setApiReady_ " + I);
            g.z6("yt.mdx.remote.cloudview.apiReady_", I)
        }, Qo0 = function (I) { g.z6("yt.mdx.remote.cloudview.initializing_", I) }, ND = function (I) {
            this.index = -1;
            this.videoId = this.listId = ""; this.volume = this.playerState = -1; this.muted = !1; this.audioTrackId = null; this.X = this.K = 0; this.trackData = null; this.hasNext = this.hasPrevious = !1; this.loadedTime = this.D = this.Y = this.J = 0; this.B = NaN; this.T = !1; this.reset(I)
        }, DS8 = function (I) {
            I.audioTrackId = null;
            I.trackData = null; I.playerState = -1; I.hasPrevious = !1; I.hasNext = !1; I.K = 0; I.X = g.J$(); I.J = 0; I.Y = 0; I.D = 0; I.loadedTime = 0; I.B = NaN; I.T = !1
        }, JN = function (I) { return I.isPlaying() ? (g.J$() - I.X) / 1E3 : 0 }, o1 = function (I, U) {
            I.K = U;
            I.X = g.J$()
        }, Xw = function (I) {
            switch (I.playerState) {
                case 1: case 1081: return (g.J$() - I.X) / 1E3 + I.K;
                case -1E3: return 0
            }return I.K
        }, xSk = function (I) { return I.T ? I.Y + JN(I) : I.Y }, iV = function (I, U, t) {
            var W = I.videoId;
            I.videoId = U; I.index = t; U != W && DS8(I)
        }, rSe = function (I) {
            var U = {};
            U.index = I.index; U.listId = I.listId; U.videoId = I.videoId; U.playerState = I.playerState; U.volume = I.volume; U.muted = I.muted; U.audioTrackId = I.audioTrackId; U.trackData = g.jp(I.trackData); U.hasPrevious = I.hasPrevious; U.hasNext = I.hasNext; U.playerTime = I.K; U.playerTimeAt = I.X; U.seekableStart = I.J; U.seekableEnd = I.Y; U.duration = I.D; U.loadedTime = I.loadedTime; U.liveIngestionTime = I.B; return U
        }, kr = function (I, U) {
            g.OR.call(this);
            ...
            (I = i4k()) && Yr(this, I); this.subscribe("yt-remote-cast2-session-change", this.mu)
        }, DD = function (I) { return new ND(I.T.getPlayerContextData()) }, GFw = function (I) { g.Kt("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange multiStateLoopEnabled loopModeChange".split(" "), function (U) { this.K.push(this.T.subscribe(U, g.sH(this.e9l, U), this)) }, I) }, qCx = function (I) {
            g.Kt(I.K, function (U) { this.T.unsubscribeByKey(U) }, I);
            I.K.length = 0
        }, xr = function (I) { return I.getState() == 1 }, rP = function (I, U) {
            var t = I.X;
            t.B.length + t.J.length < 50 && I.X.enqueue(U)
        }, ewQ = function (I, U, t) {
            var W = DD(I);
            o1(W, t); W.playerState != -1E3 && (W.playerState = U); GW(I, W)
        }, qD = function (I, U, t) { I.T.sendMessage(U, t) }, GW = function (I, U) {
            qCx(I);
            I.T.setPlayerContextData(rSe(U)); GFw(I)
        }, Yr = function (I, U) {
            I.J && (I.J.removeUpdateListener(I.on), I.J.removeMediaListener(I.Y), I.eM(null));
            I.J = U; I.J && (tN("Setting cast session: " + I.J.sessionId), I.J.addUpdateListener(I.on), I.J.addMediaListener(I.Y), I.J.media.length && I.eM(I.J.media[0]))
        }, b4Q = function (I) {
            var U = I.B.media, t = I.B.customData;
            if (U && t) { var W = DD(I); U.contentId != W.videoId && tN("Cast changing video to: " + U.contentId); W.videoId = U.contentId; W.playerState = t.playerState; o1(W, I.B.getEstimatedTime()); GW(I, W) } else tN("No cast media video. Ignoring state update.")
        }, eU = function (I, U, t) {
            return (0, g.A$)(function (W) {
                this.Oi("Failed to " + U + " with cast v2 channel. Error code: " + W.code);
                W.code != chrome.cast.ErrorCode.TIMEOUT && (this.Oi("Retrying " + U + " using MDx browser channel."), qD(this, U, t))
            }, I)
        }, TW = function (I, U, t, W) {
            W = W === void 0 ? !1 : W;
            ...
            this.J.Ow(U.token); this.subscribe("remoteQueueChange", function () { var Z = E.B.videoId; g.NS() && g.AS("yt-remote-session-video-id", Z) })
        }, Rw8 = function (I) { return g.xf(I.D, function (U) { return U.type == "LOUNGE_SCREEN" }) }, bV = function (I) { Ul("conn", I) }, BE = function (I, U) { I.publish("proxyStateChange", U) }, O4w = function (I) {
            I.K = g.vK(function () {
                bV("Connecting timeout");
                I.aJ(1)
            }, 2E4)
        }, n2H = function (I) {
            g.$p(I.K);
            ...
            Mz$(I);
            I.wk = g.vK(function () { R1(I, "getNowPlaying") }, 2E4)
        }, Mz$ = function (I) {
            g.$p(I.wk);
            I.wk = NaN
        }, BpQ = function (I) {
            bV("Channel opened");
            I.u0 && (I.u0 = !1, Vzw(I), I.l0 = g.vK(function () { bV("Timing out waiting for a screen."); I.aJ(1) }, 15E3))
        }, UiH = function (I, U) {
            var t = null;
            if (U) { var W = Rw8(I); W && (t = { clientName: W.clientName, deviceMake: W.brand, deviceModel: W.model, osVersion: W.osVersion }) } g.z6("yt.mdx.remote.remoteClient_", t); U && (n2H(I), Vzw(I)); t = I.J.Z7() && isNaN(I.K); U == t ? U && (BE(I, 1), R1(I, "getSubtitlesTrack")) : U ? (I.yM() && I.B.reset(), BE(I, 1), R1(I, "getNowPlaying"), IL8(I)) : I.aJ(1)
        }, tMe = function (I, U) {
            var t = U.params.videoId;
            delete U.params.videoId; t == I.B.videoId && (g.Ct(U.params) ? I.B.trackData = null : I.B.trackData = U.params, I.publish("remotePlayerChange"))
        }, WqY = function (I, U, t) {
            var W = U.params.videoId || U.params.video_id, E = parseInt(U.params.currentIndex, 10);
            I.B.listId = U.params.listId || I.B.listId; iV(I.B, W, E); I.publish("remoteQueueChange", t)
        }, Zg0 = function (I, U) {
            U.params = U.params || {};
            WqY(I, U, "NOW_PLAYING_MAY_CHANGE"); E96(I, U); I.publish("autoplayDismissed")
        }, E96 = function (I, U) {
            var t = parseInt(U.params.currentTime || U.params.current_time, 10);
            o1(I.B, isNaN(t) ? 0 : t); t = parseInt(U.params.state, 10); t = isNaN(t) ? -1 : t; t == -1 && I.B.playerState == -1E3 && (t = -1E3); I.B.playerState = t; t = Number(U.params.loadedTime); I.B.loadedTime = isNaN(t) ? 0 : t; I.B.J1(Number(U.params.duration)); t = I.B; var W = Number(U.params.liveIngestionTime); t.B = W; t.T = isNaN(W) ? !1 : !0; t = I.B; W = Number(U.params.seekableStartTime); U = Number(U.params.seekableEndTime); t.J = isNaN(W) ? 0 : W; t.Y = isNaN(U) ? 0 : U; I.B.playerState == 1 ? PNk(I) : Mz$(I); I.publish("remotePlayerChange")
        }, Hgt = function (I, U) {
            if (I.B.playerState !=
                -1E3) {
                    var t = 1085;
                switch (parseInt(U.params.adState, 10)) { case 1: t = 1081; break; case 2: t = 1084; break; case 0: t = 1083 }I.B.playerState = t; U = parseInt(U.params.currentTime, 10); o1(I.B, isNaN(U) ? 0 : U); I.publish("remotePlayerChange")
            }
        }, wYt = function (I, U) {
            var t = U.params.muted == "true";
            I.B.volume = parseInt(U.params.volume, 10); I.B.muted = t; I.publish("remotePlayerChange")
        }, lLe = function (I, U) {
            I.Y = U.params.videoId;
            I.publish("nowAutoplaying", parseInt(U.params.timeout, 10))
        }, dik = function (I, U) {
            I.Y = U.params.videoId || null;
            I.publish("autoplayUpNext", I.Y)
        }, Kqx = function (I, U) {
            I.X = U.params.autoplayMode;
            I.publish("autoplayModeChange", I.X); I.X == "DISABLED" && I.publish("autoplayDismissed")
        }, v9f = function (I, U) {
            var t = U.params.hasNext == "true";
            I.B.hasPrevious = U.params.hasPrevious == "true"; I.B.hasNext = t; I.publish("previousNextChange")
        }, Tp6 = function (I, U) {
            U = U.message;
            U.params ? bV("Received: action=" + U.action + ", params=" + g.k7(U.params)) : bV("Received: action=" + U.action + " {}"); switch (U.action) {
                case "loungeStatus": U = Pu(U.params.devices); I.D = g.F2(U, function (W) { return new W6(W) });
                    ...
                    break; case "gracefulDisconnect": break; case "playlistModified": WqY(I, U, "QUEUE_MODIFIED"); break; case "nowPlaying": Zg0(I, U); break; case "onStateChange": E96(I, U); break; case "onAdStateChange": Hgt(I, U); break; case "onVolumeChanged": wYt(I, U); break; case "onSubtitlesTrackChanged": tMe(I, U); break; case "nowAutoplaying": lLe(I, U); break; case "autoplayDismissed": I.publish("autoplayDismissed"); break; case "autoplayUpNext": dik(I, U); break; case "onAutoplayModeChanged": Kqx(I, U); break; case "onHasPreviousNextChanged": v9f(I,
                        U); break; case "requestAssistedSignIn": I.publish("assistedSignInRequested", U.params.authCode); break; case "onLoopModeChanged": I.publish("loopModeChange", U.params.loopMode); break; default: bV("Unrecognized action: " + U.action)
            }
        }, IL8 = function (I) {
            g.$p(I.on);
            I.on = g.vK(function () { I.aJ(1) }, 864E5)
        }, R1 = function (I, U, t) {
            t ? bV("Sending: action=" + U + ", params=" + g.k7(t)) : bV("Sending: action=" + U);
            I.J.sendMessage(U, t)
        }, cyt = function (I) {
            HE.call(this, "ScreenServiceProxy");
            this.Bk = I; this.B = []; this.B.push(this.Bk.$_s("screenChange", (0, g.A$)(this.SC, this))); this.B.push(this.Bk.$_s("onlineScreenChange", (0, g.A$)(this.u6u, this)))
        }, zMf = function (I, U) {
            vJw();
            if (!v6 || !v6.get("yt-remote-disable-remote-module-for-dev")) {
                U = g.bP("MDX_CONFIG") || U; tOt(); How(); Ol || (Ol = new M6(U ? U.loungeApiHost : void 0), cm6() && (Ol.B = "/api/loungedev")); nq || (nq = g.pQ("yt.mdx.remote.deferredProxies_") || [], g.z6("yt.mdx.remote.deferredProxies_", nq)); $iY(); var t = VT(); if (!t) {
                    var W = new vE(Ol, U ? U.disableAutomaticScreenCache || !1 : !1); g.z6("yt.mdx.remote.screenService_", W); t = VT(); var E = {}; U && (E = {
                        appId: U.appId, disableDial: U.disableDial, theme: U.theme, loadCastApiSetupScript: U.loadCastApiSetupScript,
                        disableCastApi: U.disableCastApi, enableDialLoungeToken: U.enableDialLoungeToken, enableCastLoungeToken: U.enableCastLoungeToken, forceMirroring: U.forceMirroring
                    }); g.z6("yt.mdx.remote.enableConnectWithInitialState_", U ? U.enableConnectWithInitialState || !1 : !1); a3H(I, W, function (Z) { Z ? MD() && a1(MD(), "YouTube TV") : W.subscribe("onlineScreenChange", function () { c6("yt-remote-receiver-availability-change") }) }, E)
                } U && !g.pQ("yt.mdx.remote.initialized_") && (g.z6("yt.mdx.remote.initialized_", !0), PE("Initializing: " + g.k7(U)),
                    Il.push(g.b0("yt-remote-cast2-api-ready", function () { c6("yt-remote-api-ready") })), Il.push(g.b0("yt-remote-cast2-availability-change", function () { c6("yt-remote-receiver-availability-change") })), Il.push(g.b0("yt-remote-cast2-receiver-selected", function () {
                        UF(null);
                        c6("yt-remote-auto-connect", "cast-selector-receiver")
                    })), Il.push(g.b0("yt-remote-cast2-receiver-resumed", function () { c6("yt-remote-receiver-resumed", "cast-selector-receiver") })), Il.push(g.b0("yt-remote-cast2-session-change", uiL)), Il.push(g.b0("yt-remote-connection-change", function (Z) { Z ? a1(MD(), "YouTube TV") : tb() || (a1(null, null), Xdf()) })), Il.push(g.b0("yt-remote-cast2-session-failed", function () { c6("yt-remote-connection-failed") })), I = hM8(), U.isAuto && (I.id += "#dial"), E = U.capabilities || [], E.length > 0 && (I.capabilities =
                        E), I.name = U.device, I.app = U.app, (U = U.theme) && (I.theme = U), PE(" -- with channel params: " + g.k7(I)), I ? (g.AS("yt-remote-session-app", I.app), g.AS("yt-remote-session-name", I.name)) : (g.ao("yt-remote-session-app"), g.ao("yt-remote-session-name")), g.z6("yt.mdx.remote.channelParams_", I), t.start(), MD() || SJt())
            }
        }, Lqw = function () {
            var I = VT().Bk.$_gos();
            var U = WA(); U && EF() && (UMH(I, U) || I.push(U)); return IGH(I)
        }, miV = function () {
            var I = pYt();
            !I && AN() && o2L() && (I = { key: "cast-selector-receiver", name: o2L() }); return I
        }, pYt = function () {
            var I = Lqw(), U = WA();
            U || (U = tb()); return g.xf(I, function (t) { return U && Zv(U, t.key) ? !0 : !1 })
        }, WA = function () {
            var I = MD();
            if (!I) return null; var U = VT().Ii(); return wC(U, I)
        }, uiL = function (I) {
            PE("remote.onCastSessionChange_: " + H6(I));
            if (I) { var U = WA(); if (U && U.id == I.id) { if (a1(U.id, "YouTube TV"), I.idType == "shortLived" && (I = I.token)) Zg && (Zg.token = I), (U = EF()) && U.Ow(I) } else U && HA(), w$(I, 1) } else EF() && HA()
        }, HA = function () {
            sl() ? jU().stopSession() : fq("stopSession called before API ready.");
            var I = EF(); I && (I.disconnect(1), g9$(null))
        }, CG6 = function () {
            var I = EF();
            return !!I && I.getProxyState() != 3
        }, PE = function (I) { Ul("remote", I) }, VT = function () {
            if (!yyY) {
                var I = g.pQ("yt.mdx.remote.screenService_");
                yyY = I ? new cyt(I) : null
            } return yyY
        }, MD = function () { return g.pQ("yt.mdx.remote.currentScreenId_") }, Fq0 = function (I) { g.z6("yt.mdx.remote.currentScreenId_", I) }, QbH = function () { return g.pQ("yt.mdx.remote.connectData_") }, UF = function (I) { g.z6("yt.mdx.remote.connectData_", I) }, EF = function () { return g.pQ("yt.mdx.remote.connection_") }, g9$ = function (I) {
            var U = EF();
            UF(null); I || Fq0(""); g.z6("yt.mdx.remote.connection_", I); nq && (g.Kt(nq, function (t) { t(I) }), nq.length = 0);
            U && !I ? c6("yt-remote-connection-change", !1) : !U && I && c6("yt-remote-connection-change", !0)
        }, tb = function () {
            var I = g.NS();
            if (!I) return null; var U = VT(); if (!U) return null; U = U.Ii(); return wC(U, I)
        }, w$ = function (I, U) {
            MD();
            WA() && WA(); if (li) Zg = I; else {
                Fq0(I.id); var t = g.pQ("yt.mdx.remote.enableConnectWithInitialState_") || !1; I = new TW(Ol, I, hM8(), t); I.connect(U, QbH()); I.subscribe("beforeDisconnect", function (W) { c6("yt-remote-before-disconnect", W) });
            ...
            var I = tb();
            I ? (PE("Resume connection to: " + H6(I)), w$(I, 0)) : (KL(), Xdf(), PE("Skipping connecting because no session screen found."))
        }, $iY = function () {
            var I = hM8();
            if (g.Ct(I)) { I = dC(); var U = g.sC("yt-remote-session-name") || "", t = g.sC("yt-remote-session-app") || ""; I = { device: "REMOTE_CONTROL", id: I, name: U, app: t, mdxVersion: 3 }; I.authuser = String(g.bP("SESSION_INDEX", "0")); (U = g.bP("DELEGATED_SESSION_ID")) && (I.pageId = String(U)); g.z6("yt.mdx.remote.channelParams_", I) }
        }, hM8 = function () { return g.pQ("yt.mdx.remote.channelParams_") || {} }, Ayt = function (I, U, t) {
            g.q.call(this);
            ...
            I = this.Or; I.Tg(); I.subscribe("proxyStateChange", this.by, this); I.subscribe("remotePlayerChange", this.u9, this); I.subscribe("remoteQueueChange", this.HC, this); I.subscribe("previousNextChange", this.md, this); I.subscribe("nowAutoplaying", this.Ns, this); I.subscribe("autoplayDismissed", this.qs, this); g.e(this, this.J); g.e(this, this.D); g.e(this, this.W); g.e(this, this.on); g.e(this, this.Y); this.ys(); this.HC(); this.u9()
        }, fL0 = function (I, U) {
            if (d$(I)) {
                I.Or.unsubscribe("remotePlayerChange", I.u9, I);
                var t = Math.round(U.volume); U = !!U.muted; var W = DD(I.Or); if (t !== W.volume || U !== W.muted) I.Or.setVolume(t, U), I.on.start(); I.Or.subscribe("remotePlayerChange", I.u9, I)
            }
        }, sbx = function (I) {
            I.HL(0);
            I.J.stop(); I.wS(new g.zC(64))
        }, aLw = function (I, U) {
            if (d$(I) && !I.X) {
                var t = null;
                U && (t = { style: I.G.getSubtitlesUserSettings() }, Object.assign(t, U)); I.Or.Q7(vA(I).videoId, t); I.T = DD(I.Or).trackData
            }
        }, Kl = function (I, U) {
            var t = I.G.getPlaylist();
            if (t == null ? 0 : t.listId) { var W = t.index; var E = t.listId.toString() } t = vA(I); I.Or.playVideo(t.videoId, U, W, E, t.playerParams, t.mu, A9w(t)); I.wS(new g.zC(1))
        }, N6H = function (I, U) {
            if (U) {
                var t = I.G.getOption("captions", "tracklist", { lx: 1 });
                t && t.length ? (I.G.setOption("captions", "track", U), I.X = !1) : (I.G.loadModule("captions"), I.X = !0)
            } else I.G.setOption("captions", "track", {})
        }, d$ = function (I) { return DD(I.Or).videoId === vA(I).videoId }, vA = function (I) { return I.G.getVideoData({ playerType: 1 }) }, Jy8 = function (I, U) {
            g.xA.call(this, I);
            this.B = U
        }, cA = function () {
            g.T.call(this, {
                Z: "div",
                U: "ytp-mdx-popup-dialog", j: { role: "dialog" }, C: [{
                    Z: "div", U: "ytp-mdx-popup-dialog-inner-content", C: [{ Z: "div", U: "ytp-mdx-popup-title", Fe: "You're signed out" }, { Z: "div", U: "ytp-mdx-popup-description", Fe: "Videos you watch may be added to the TV's watch history and influence TV recommendations. To avoid this, cancel and sign in to YouTube on your computer." }, {
                        Z: "div", U: "ytp-mdx-privacy-popup-buttons", C: [{ Z: "button", fl: ["ytp-button", "ytp-mdx-privacy-popup-cancel"], Fe: "Cancel" }, {
                            Z: "button", fl: ["ytp-button",
                                "ytp-mdx-privacy-popup-confirm"], Fe: "Confirm"
                        }]
                    }]
                }]
            }); this.fade = new g.Bw(this, 250); this.cancelButton = this.e6("ytp-mdx-privacy-popup-cancel"); this.confirmButton = this.e6("ytp-mdx-privacy-popup-confirm"); g.e(this, this.fade); this.L(this.cancelButton, "click", this.B); this.L(this.confirmButton, "click", this.J)
        }, $t = function (I) {
            g.T.call(this, {
                Z: "div",
                U: "ytp-remote", C: [{ Z: "div", U: "ytp-remote-display-status", C: [{ Z: "div", U: "ytp-remote-display-status-icon", C: [g.rvG()] }, { Z: "div", U: "ytp-remote-display-status-text", Fe: "{{statustext}}" }] }]
            }); this.api = I; this.fade = new g.Bw(this, 250); g.e(this, this.fade); this.L(I, "presentingplayerstatechange", this.onStateChange); this.Z5(I.getPlayerStateObject())
        }, ui = function (I, U) {
            g.A_.call(this, "Play on", 1, I, U);
            this.G = I; this.ZI = {}; this.L(I, "onMdxReceiversChange", this.J); this.L(I, "presentingplayerstatechange", this.J); this.J()
        }, o9L = function (I) {
            g.SW.call(this, I);
            this.SJ = { key: PgY(), name: "This computer" }; this.xQ = null; this.subscriptions = []; this.oA = this.Or = null; this.ZI = [this.SJ]; this.PF = this.SJ; this.cQ = new g.zC(64); this.xo = 0; this.Og = -1; this.Yg = !1; this.ol = this.Vg = this.gs = null; if (!g.Vn(this.player.S()) && !g.f7(this.player.S())) { I = this.player; var U = g.jI(I); U && (U = U.tY()) && (U = new ui(I, U), g.e(this, U)); U = new $t(I); g.e(this, U); g.RY(I, U.element, 4); this.gs = new cA; g.e(this, this.gs); g.RY(I, this.gs.element, 4); this.Yg = !!tb() }
        }, Sg = function (I) {
            I.Vg && (I.player.removeEventListener("presentingplayerstatechange",
                I.Vg), I.Vg = null)
        }, XYe = function (I, U, t) {
            I.cQ = t;
            I.player.publish("presentingplayerstatechange", new g.U_(t, U))
        }, z7 = function (I, U) {
            if (U.key !== I.PF.key) if (U.key === I.SJ.key) HA();
            else if (jbf(I) && igQ(I), I.PF = U, !g.f7(I.player.S())) {
                var t = I.player.getPlaylistId(); var W = I.player.getVideoData({ playerType: 1 }); var E = W.videoId; if (!t && !E || (I.player.getAppState() === 2 || I.player.getAppState() === 1) && I.player.S().V("should_clear_video_data_on_player_cued_unstarted")) W = null; else {
                    var Z = I.player.getPlaylist(); if (Z) { var H = []; for (var l = 0; l < Z.length; l++)H[l] = g.$N(Z, l).videoId } else H = [E]; Z = I.player.getCurrentTime(1); I = {
                        videoIds: H, listId: t, videoId: E, playerParams: W.playerParams, clickTrackingParams: W.mu,
                        index: Math.max(I.player.getPlaylistIndex(), 0), currentTime: Z === 0 ? void 0 : Z
                    }; (W = A9w(W)) && (I.locationInfo = W); W = I
                } PE("Connecting to: " + g.k7(U)); U.key == "cast-selector-receiver" ? (UF(W || null), U = W || null, sl() ? jU().setLaunchParams(U) : fq("setLaunchParams called before ready.")) : !W && CG6() && MD() == U.key ? c6("yt-remote-connection-change", !0) : (HA(), UF(W || null), W = VT().Ii(), (U = wC(W, U.key)) && w$(U, 1))
            }
        }, jbf = function (I) {
            var U = I.player.S();
            return !U.V("mdx_enable_privacy_disclosure_ui") || I.isLoggedIn() || I.Yg || !I.gs ? !1 : g.v7(U) || g.u$(U)
        }, igQ = function (I) {
            I.player.getPlayerStateObject().isPlaying() ? I.player.pauseVideo() : (I.Vg = function (U) { !I.Yg && g.W8(U, 8) && (I.player.pauseVideo(), Sg(I)) }, I.player.addEventListener("presentingplayerstatechange", I.Vg));
    ...
    g.z.ME = function (I) {
        tk(this); var U = 0, t = this.JO, W = this, E = new g.aK; E.next = function () { if (t != W.JO) throw Error("The map has changed since the iterator was created"); if (U >= W.B.length) return g.dz; var Z = W.B[U++]; return g.NE(I ? Z : W.J[Z]) };
        return E
    };
    ...
    g.z.WA = function (I) {
        try {
            if (I == this.B) a: {
                var U = g.eY(this.B), t = this.B.J, W = this.B.getStatus(); if (!(U < 3) && (U != 3 || this.B && (this.J.J || g.BG(this.B) || g.Tu(this.B)))) {
                    this.Rn || U != 4 || t == 7 || (t == 8 || W <= 0 ? LL(3) : LL(2)); boe(this); var E = this.B.getStatus(); this.Fp = E; var Z = xMk(this); if (this.K = E == 200) {
                        if (this.k$ && !this.Gg) { b: { if (this.B) { var H = g.RQ(this.B, "X-HTTP-Initial-Response"); if (H && !g.q2(H)) { var l = H; break b } } l = null } if (I = l) this.Gg = !0, Ikf(this, I); else { this.K = !1; this.X = 3; pL(12); FL(this); QH(this); break a } } if (this.rk) {
                            I =
                            !0; for (var d; !this.Rn && this.Y < Z.length;)if (d = qxe(this, Z), d == rm0) { U == 4 && (this.X = 4, pL(14), I = !1); break } else if (d == GKQ) { this.X = 4; pL(15); I = !1; break } else Ikf(this, d); DMx(this) && this.Y != 0 && (this.J.B = this.J.B.slice(this.Y), this.Y = 0); U != 4 || Z.length != 0 || this.J.J || (this.X = 1, pL(16), I = !1); this.K = this.K && I; I ? Z.length > 0 && !this.RF && (this.RF = !0, this.D.wW(this)) : (FL(this), QH(this))
                        } else Ikf(this, Z); U == 4 && FL(this); this.K && !this.Rn && (U == 4 ? BTQ(this.D, this) : (this.K = !1, yH(this)))
                    } else g.xX3(this.B), E == 400 && Z.indexOf("Unknown SID") >
                        0 ? (this.X = 3, pL(12)) : (this.X = 0, pL(13)), FL(this), QH(this)
                }
            }
        } catch (K) { } finally { }
    };
    ...
    g.z.iL = function (I) {
        if (this.K) if (this.K = null, this.YX == 1) {
            if (!I) {
                this.cK = Math.floor(Math.random() * 1E5); I = this.cK++; var U = new CL(this, "", I), t = this.on; this.k$ && (t ? (t = g.QC(t), g.AD(t, this.k$)) : t = this.k$); this.Y !== null || this.OJ || (U.QQ = t, t = null); var W; if (this.oF) a: {
                    for (var E = W = 0; E < this.D.length; E++) { b: { var Z = this.D[E]; if ("__data__" in Z.map && (Z = Z.map.__data__, typeof Z === "string")) { Z = Z.length; break b } Z = void 0 } if (Z === void 0) break; W += Z; if (W > 4096) { W = E; break a } if (W === 4096 || E === this.D.length - 1) { W = E + 1; break a } } W =
                        this.MF
                } else W = this.MF; W = $V0(this, U, W); E = this.QQ.clone(); g.w2(E, "RID", I); g.w2(E, "CVER", 22); this.rk && g.w2(E, "X-HTTP-Session-Id", this.rk); o7(this, E); t && (this.OJ ? W = "headers=" + g.YE(g.dRz(t)) + "&" + W : this.Y && g.KU(E, this.Y, t)); nJ$(this.J, U); this.Sz && g.w2(E, "TYPE", "init"); this.oF ? (g.w2(E, "$req", W), g.w2(E, "SID", "null"), U.k$ = !0, Yxx(U, E, null)) : Yxx(U, E, W); this.YX = 2
            }
        } else this.YX == 3 && (I ? utf(this, I) : this.D.length == 0 || Wd$(this.J) || utf(this))
    };
    ...
    g.z.aj = function (I) {
        try {
            if (I == this.y3) a: {
                var U = g.eY(this.y3), t = this.y3.J, W = this.y3.getStatus(); if (g.Sy && !g.R0("420+")) { if (U < 4) break a } else if (U < 3 || U == 3 && !g.BG(this.y3)) break a; this.OS || U != 4 || t == 7 || (t == 8 || W <= 0 ? this.B.hL(3) : this.B.hL(2)); o6H(this); var E = this.y3.getStatus(); this.BX = E; var Z = g.BG(this.y3); if (this.Dt = E == 200) {
                    U == 4 && rC(this); if (this.rk) {
                        for (I = !0; !this.OS && this.oC < Z.length;) {
                            var H = NEx(this, Z); if (H == spk) { U == 4 && (this.hO = 4, Dv(15), I = !1); break } else if (H == akx) { this.hO = 4; Dv(16); I = !1; break } else ipx(this,
                                H)
                        } U == 4 && Z.length == 0 && (this.hO = 1, Dv(17), I = !1); this.Dt = this.Dt && I; I || (rC(this), XD8(this))
                    } else ipx(this, Z); this.Dt && !this.OS && (U == 4 ? this.B.oG(this) : (this.Dt = !1, AeQ(this)))
                } else E == 400 && Z.indexOf("Unknown SID") > 0 ? (this.hO = 3, Dv(13)) : (this.hO = 0, Dv(14)), rC(this), XD8(this)
            }
        } catch (l) { } finally { }
    };
    ...
    g.z.Ny = function (I, U) {
        if (this.B != 0 && (this.W5 == I || this.wj == I)) if (this.BI = I.BX, this.wj == I && this.B == 3) if (this.MW > 7) { try { var t = this.X.parse(U) } catch (W) { t = null } if (Array.isArray(t) && t.length == 3) if (I = t, I[0] == 0) a: { if (!this.xL) { if (this.W5) if (this.W5.oI + 3E3 < this.wj.oI) TV(this), this.W5.cancel(), this.W5 = null; else break a; tc$(this); Dv(19) } } else this.OZ = I[1], 0 < this.OZ - this.AR && I[2] < 37500 && this.AE && this.rL == 0 && !this.xR && (this.xR = Y0((0, g.A$)(this.hk, this), 6E3)); else Ou(this, 11) } else U != "y2f%" && Ou(this, 11); else if (this.W5 ==
    ...
    g.z.oG = function (I) {
        if (this.W5 == I) { TV(this); this.W5 = null; var U = 2 } else if (this.wj == I) this.wj = null, U = 1; else return; this.BI = I.BX; if (this.B != 0) if (I.Dt) if (U == 1) { U = I.Gl ? I.Gl.length : 0; I = Date.now() - I.oI; var t = k0; t.dispatchEvent(new eNQ(t, U, I, this.DT)); BE6(this); this.Ug && this.Ug.eX(this, this.D); this.D.length = 0 } else IMf(this); else {
            t = I.getLastError(); var W; if (!(W = t == 3 || t == 7 || t == 0 && this.BI > 0)) {
                if (W = U == 1) this.wj || this.Ao || this.B == 1 || this.DT >= 2 ? W = !1 : (this.Ao = Y0((0, g.A$)(this.ma, this, I), UH0(this, this.DT)), this.DT++,
                    W = !0); W = !(W || U == 2 && tc$(this))
            } if (W) switch (t) { case 1: Ou(this, 5); break; case 4: Ou(this, 10); break; case 3: Ou(this, 6); break; case 7: Ou(this, 12); break; default: Ou(this, 2) }
        }
    };
    ...
    g.z.connect = function (I, U, t) {
        var W = this, E, Z, H, l; return g.r(function (d) {
    ...
    g.z.Ez = function (I) {
        var U = I == 2 && this.B.BI == 401; I == 4 || U || (this.D && !this.J.isActive() && (g.vl(this.J), this.J = new nL(this.TI, this), this.D = !1), this.J.start()); this.publish("handlerError", I, U); U = Object.keys(YJ6).find(function (t) { return YJ6[t] === I });
    ...
    g.z.update = function () {
        G_x("Updating availability on schedule."); var I = this.K(), U = g.$i(this.B, function (t, W) { return t && !!wC(I, W) }, this);
        B4k(this, U)
    };
    ...
    g.z.rR = function (I, U, t, W, E, Z) {
        var H = this; this.info("getDialScreenByPairingCode " + I + " / " + U); var l = new xH0(this.T, I, U, t, W); l.subscribe("pairingComplete", function (d, K) { g.vl(l); E(cE(H, d), K) });
        l.subscribe("pairingFailed", function (d) { g.vl(l); Z(d) });
        l.start(); return (0, g.A$)(l.stop, l)
    };
    g.z.qr = function (I, U, t, W) {
        g.g4(P6(this.T, "/pairing/get_screen"), {
            method: "POST", postParams: { pairing_code: I }, timeout: 5E3, onSuccess: (0, g.A$)(function (E, Z) { E = new Eu(Z.screen || {}); if (!E.name || VcV(this, E.name)) { a: { Z = E.name; for (var H = 2, l = U(Z, H); VcV(this, l);) { H++; if (H > 20) break a; l = U(Z, H) } Z = l } E.name = Z } t(cE(this, E)) }, this),
    ...
    g.z.init = function (I, U) {
        chrome.cast.timeout.requestSession = 3E4; var t = new chrome.cast.SessionRequest(this.W, [chrome.cast.Capability.AUDIO_OUT]); g.Sc("desktop_enable_cast_connect") && (t.androidReceiverCompatible = !0); this.on || (t.dialRequest = new chrome.cast.DialRequest("YouTube")); var W = chrome.cast.AutoJoinPolicy.TAB_AND_ORIGIN_SCOPED; I = I || this.K ? chrome.cast.DefaultActionPolicy.CAST_THIS_TAB : chrome.cast.DefaultActionPolicy.CREATE_SESSION; var E = (0, g.A$)(this.u8g, this); t = new chrome.cast.ApiConfig(t, (0, g.A$)(this.kC,
            this), E, W, I); t.customDialLaunchCallback = (0, g.A$)(this.q5K, this); chrome.cast.initialize(t, (0, g.A$)(function () { this.Tg() || (chrome.cast.addReceiverActionListener(this.X), Jvt(), this.J.subscribe("onlineScreenChange", (0, g.A$)(this.fO, this)), this.D = CNY(this), chrome.cast.setCustomReceivers(this.D, function () { }, (0, g.A$)(function (Z) { this.Oi("Failed to set initial custom receivers: " + g.k7(Z)) }, this)), this.publish("yt-remote-cast2-availability-change", yT(this)), U(!0)) }, this), (0, g.A$)(function (Z) {
                this.Oi("Failed to initialize API: " +
                    g.k7(Z));
                U(!1)
            }, this))
    };
    g.z.GAu = function (I, U) {
        Cq("Setting connected screen ID: " + I + " -> " + U); if (this.B) { var t = this.B.B; if (!I || t && t.id != I) Cq("Unsetting old screen status: " + this.B.J.friendlyName), Fw(this, null) } if (I && U) {
            if (!this.B) {
                I = wC(this.J.Ii(), I); if (!I) { Cq("setConnectedScreenStatus: Unknown screen."); return } if (I.idType == "shortLived") { Cq("setConnectedScreenStatus: Screen with id type to be short lived."); return } t = mS8(this, I); t || (Cq("setConnectedScreenStatus: Connected receiver not custom..."), t = new chrome.cast.Receiver(I.uuid ?
                ...
                Cq("setConnectedScreenStatus: new active receiver: " + t.friendlyName); Fw(this, new mF(this.J, t), !0)
            } this.B.ER(U)
        } else Cq("setConnectedScreenStatus: no screen.")
    };
    ...
    g.z.JU4 = function (I, U) {
        if (!this.Tg()) if (I) switch (I.friendlyName = chrome.cast.unescape(I.friendlyName), Cq("onReceiverAction_ " + I.label + " / " + I.friendlyName + "-- " + U), U) {
            case chrome.cast.ReceiverAction.CAST: if (this.B) if (this.B.J.label != I.label) Cq("onReceiverAction_: Stopping active receiver: " + this.B.J.friendlyName), this.B.stop(); else { Cq("onReceiverAction_: Casting to active receiver."); this.B.B && this.publish("yt-remote-cast2-session-change", this.B.B); break } switch (I.receiverType) {
                case chrome.cast.ReceiverType.CUSTOM: Fw(this,
                    new mF(this.J, I)); break; case chrome.cast.ReceiverType.DIAL: Fw(this, new zW(this.J, I, this.T, this.config_)); break; case chrome.cast.ReceiverType.CAST: Fw(this, new SU(this.J, I, this.config_)); break; default: this.Oi("Unknown receiver type: " + I.receiverType)
            }break; case chrome.cast.ReceiverAction.STOP: this.B && this.B.J.label == I.label ? this.B.stop() : this.Oi("Stopping receiver w/o session: " + I.friendlyName)
        } else this.Oi("onReceiverAction_ called without receiver.")
    };
    g.z.q5K = function (I) {
        if (this.Tg()) return Promise.reject(Error("disposed")); var U = I.receiver; U.receiverType != chrome.cast.ReceiverType.DIAL && (this.Oi("Not DIAL receiver: " + U.friendlyName), U.receiverType = chrome.cast.ReceiverType.DIAL); var t = this.B ? this.B.J : null; if (!t || t.label != U.label) return this.Oi("Receiving DIAL launch request for non-clicked DIAL receiver: " + U.friendlyName), Promise.reject(Error("illegal DIAL launch")); if (t && t.label == U.label && t.receiverType != chrome.cast.ReceiverType.DIAL) {
            if (this.B.B) return Cq("Reselecting dial screen."),
                this.publish("yt-remote-cast2-session-change", this.B.B), Promise.resolve(new chrome.cast.DialLaunchResponse(!1)); this.Oi('Changing CAST intent from "' + t.receiverType + '" to "dial" for ' + U.friendlyName); Fw(this, new zW(this.J, U, this.T, this.config_))
        } U = this.B; U.W = I; U.W.appState == chrome.cast.DialAppState.RUNNING ? (I = U.W.extraData || {}, t = I.screenId || null, Lq(U) && I.loungeToken ? I.loungeTokenRefreshIntervalMs ? I = SCk(U, {
            name: U.J.friendlyName, screenId: I.screenId, loungeToken: I.loungeToken, dialId: U.W.receiver.label,
            screenIdType: "shortLived"
        }, I.loungeTokenRefreshIntervalMs) : (g.Rp(Error("No loungeTokenRefreshIntervalMs presents in additionalData: " + JSON.stringify(I) + ".")), I = zw0(U, t)) : I = zw0(U, t)) : I = uVx(U); return I
    };
    g.z.kC = function (I) {
        var U = this; if (!this.Tg() && !this.K) {
            Cq("New cast session ID: " + I.sessionId); var t = I.receiver; if (t.receiverType != chrome.cast.ReceiverType.CUSTOM) {
                if (!this.B) if (t.receiverType == chrome.cast.ReceiverType.CAST) Cq("Got resumed cast session before resumed mdx connection."), t.friendlyName = chrome.cast.unescape(t.friendlyName), Fw(this, new SU(this.J, t, this.config_), !0); else { this.Oi("Got non-cast session without previous mdx receiver event, or mdx resume."); return } var W = this.B.J, E = wC(this.J.Ii(),
    ...
    g.z.connect = function (I, U) {
        if (U) {
            var t = U.listId, W = U.videoId, E = U.videoIds, Z = U.playerParams, H = U.clickTrackingParams, l = U.index, d = { videoId: W }, K = U.currentTime, v = U.locationInfo; U = U.loopMode; K !== void 0 && (d.currentTime = K <= 5 ? 0 : K); Z && (d.playerParams = Z); v && (d.locationInfo = v); H && (d.clickTrackingParams = H); t && (d.listId = t); E && E.length > 0 && (d.videoIds = E.join(",")); l !== void 0 && (d.currentIndex = l); this.Rn && (d.loopMode = U || "LOOP_MODE_OFF"); t && (this.B.listId = t); this.B.videoId = W; this.B.index = l || 0; this.B.state = 3; o1(this.B,
                K); this.X = "UNSUPPORTED"; t = this.Rn ? "setInitialState" : "setPlaylist"; bV("Connecting with " + t + " and params: " + g.k7(d)); this.J.connect({ method: t, params: g.k7(d) }, I, wQx())
        } else bV("Connecting without params"), this.J.connect({}, I, wQx()); O4w(this)
    };
    ...
    g.z.YgQ = function (I) {
        var U = this, t = new ND(I); t.videoId && t.videoId != this.B.videoId && (this.T = t.videoId, g.$p(this.W), this.W = g.vK(function () { if (U.T) { var E = U.T; U.T = null; U.B.videoId != E && R1(U, "getNowPlaying") } }, 5E3));
    ...
    g.z.yM = function () {
        var I = this.J.getDeviceId(), U = g.xf(this.D, function (t) { return t.type == "REMOTE_CONTROL" && t.id != I });
        return U ? U.id : ""
    };
    ...
    g.z.PN = function (I) {
        var U = g.dx.apply(1, arguments); if (this.Or.D != 2) if (d$(this)) { if (DD(this.Or).playerState != 1081 || I !== "control_seek") switch (I) { case "control_toggle_play_pause": DD(this.Or).isPlaying() ? this.Or.pause() : this.Or.play(); break; case "control_play": this.Or.play(); break; case "control_pause": this.Or.pause(); break; case "control_seek": this.Y.lw(U[0], U[1]); break; case "control_subtitles_set_track": aLw(this, U[0]); break; case "control_set_audio_track": this.setAudioTrack(U[0]) } } else switch (I) {
            case "control_toggle_play_pause": case "control_play": case "control_pause": U =
    ...
    g.z.u9 = function () {
        if (d$(this)) {
            this.J.stop(); var I = DD(this.Or); switch (I.playerState) { case 1080: case 1081: case 1084: case 1085: this.B.Og = 1; break; case 1082: case 1083: this.B.Og = 0; break; default: this.B.Og = -1 }switch (I.playerState) {
                case 1081: case 1: this.wS(new g.zC(8)); this.BT(); break; case 1085: case 3: this.wS(new g.zC(9)); break; case 1083: case 0: this.wS(new g.zC(2)); this.Y.stop(); this.HL(this.G.getVideoData().lengthSeconds); break; case 1084: this.wS(new g.zC(4)); break; case 2: this.wS(new g.zC(4)); this.HL(Xw(I));
                    break; case -1: this.wS(new g.zC(64)); break; case -1E3: this.wS(new g.zC(128, { errorCode: "mdx.remoteerror", errorMessage: "This video is not available for remote playback.", zN: 2 }))
            }I = DD(this.Or).trackData; var U = this.T; (I || U ? I && U && I.trackName == U.trackName && I.languageCode == U.languageCode && I.languageName == U.languageName && I.kind == U.kind : 1) || (this.T = I, N6H(this, I)); I = DD(this.Or); I.volume === -1 || Math.round(this.G.getVolume()) === I.volume && this.G.isMuted() === I.muted || this.on.isActive() || this.w7()
        } else sbx(this)
    };
    ...
    g.z.isLoggedIn = function () { var I, U; return ((I = g.bP("PLAYER_CONFIG")) == null ? void 0 : (U = I.args) == null ? void 0 : U.authuser) !== void 0 ? !0 : !(!g.bP("SESSION_INDEX") && !g.bP("LOGGED_IN")) }; g.hC("remote", o9L);
})(_yt_player);
